...
hostName=$(hostname)
mkdir -p /mnt/beegfs_bsl/production/movefromlocaltodfs/report_new/MOBILE_MONEY_move/${currDate}
java -Xmx30g -Xms30g -Dlog4j.configurationFile=/mnt/beegfs_bsl/tools/fileOps/log4j2.xml -jar /mnt/beegfs_bsl/tools/fileOps/FileOps_2.11-0.1-SNAPSHOT_hdfs.jar -in /data/data_lz/beegfs/live/MOBILE_MONEY/incoming -out /mnt/beegfs_bsl/production/movefromlocaltodfs/report_new/MOBILE_MONEY_move/${currDate}/ -mv /mnt/beegfs_bsl/live/MOBILE_MONEY/Clean -od -of -tf 1 -nt 60 -dp 15   -re -rcm -rfl -nosim -effl "^.*\.(_COPYING_|tmp|TMP)$" -effl "^\..*" 2>&1 | tee "/mnt/beegfs_bsl/production/logs/movefromlocaltodfs_MOBILE_MONEY_MOVE_${currDate}_$mytime.log"
...
mkdir -p /mnt/beegfs_bsl/production/movefromlocaltodfs/report_new/MOBILE_MONEY/${currDate}
python3.6  /nas/share05/tools/DataCleaner/CleanLineFeedsInFields.py  -od /mnt/beegfs_bsl/live/MOBILE_MONEY/testdir  -id /mnt/beegfs_bsl/live/MOBILE_MONEY/Clean -im ".*"  -dm "|"  2>&1 | tee /nas/share05/tools/DataCleaner/log/MOBILE_MONEY_DataCleaner_log_$(date +%Y%m%d_%s).txt

mkdir -p /mnt/beegfs_bsl/production/movefromlocaltodfs/report_new/MOBILE_MONEY_move_2/${currDate}
java -Xmx30g -Xms30g -Dlog4j.configurationFile=/mnt/beegfs_bsl/tools/fileOps/log4j2.xml -jar /mnt/beegfs_bsl/tools/fileOps/FileOps_2.11-0.1-SNAPSHOT_hdfs.jar -in /mnt/beegfs_bsl/live/MOBILE_MONEY/Clean -out /mnt/beegfs_bsl/production/movefromlocaltodfs/report_new/MOBILE_MONEY_move_2/${currDate}/ -mv /mnt/beegfs_bsl/live/MOBILE_MONEY/Clean_2 -od -of -tf 1 -nt 60 -dp 15   -re -rcm -rfl -nosim -effl "^.*\.(_COPYING_|tmp|TMP)$" -effl "^\..*" 2>&1 | tee "/mnt/beegfs_bsl/production/logs/movefromlocaltodfs_MOBILE_MONEY_MOVE_${currDate}_$mytime.log"

java -Xmx30g -Xms30g -Dlog4j.configurationFile=/mnt/beegfs_bsl/tools/fileOps/log4j2.xml -jar /mnt/beegfs_bsl/tools/fileOps/FileOps_2.11-0.1-SNAPSHOT_hdfs.jar -in /mnt/beegfs_bsl/live/MOBILE_MONEY/testdir -out /mnt/beegfs_bsl/production/movefromlocaltodfs/report_new/MOBILE_MONEY/${currDate}/ -mv /mnt/beegfs_bsl/live/MOBILE_MONEY/incoming -od -of -tf 1 -op lineCount -nt 60 -dp 15   -re -rcm -rfl -nosim -effl "^.*\.(_COPYING_|tmp|TMP)$" -effl "^\..*" 2>&1 | tee "/mnt/beegfs_bsl/production/logs/movefromlocaltodfs_MOBILE_MONEY_${currDate}_$mytime.log"
