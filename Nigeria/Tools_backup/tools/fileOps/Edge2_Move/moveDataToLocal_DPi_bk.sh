...
java -Xmx30g -Xms30g -Dlog4j.configurationFile=/mnt/beegfs/tools/fileOps/log4j2.xml -jar /mnt/beegfs/tools/fileOps/FileOps_2.11-0.1-SNAPSHOT_hdfs.jar -in /data/data_lz/beegfs/live/DPI -out /mnt/beegfs/production/movefromlocaltodfs/report/ -mv /mnt/beegfs/live/DPI -od -of -tf 1 -op lineCount -nt 60 -dp 15  -rcm -re -nosim -effl "^.*\.tmp$" 2>&1 | tee "/mnt/beegfs/production/logs/movefromlocaltodfs_DPI_${currDate}_$mytime.log"
