...
rm -r /nas/share05/tools/ExtractTools/KM_USER_ROLE/logs/${removeDir}
...
bash /nas/share05/tools/ExtractTools/scripts/replaceDump.sh KM_USER_ROLE ${yest}  



bash /nas/share05/tools/ExtractTools/KM_USER_ROLE/driver.sh /nas/share05/tools/ExtractTools/KM_USER_ROLE /nas/share05/tools/ExtractTools/KM_USER_ROLE/tmp $yest 
retVal=$?
if [ $retVal -eq 0 ];
then
mv /nas/share05/tools/ExtractTools/KM_USER_ROLE/tmp/$yest /mnt/beegfs_bsl/live/DB_extract_lz/KM_USER_ROLE/incoming
retVal=$?
if [ $retVal -eq 0 ];
then
