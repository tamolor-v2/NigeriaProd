...
#                kv="\${date}=${DATE};\${hour}=${hour};\${minS}=00;\${minE}=29;\${anum}=${anum}"
                file_name=".${run_date}_TBL_ORDER_DTLS_VIEW.gz"
                log_file=${run_date}_TBL_ORDER_DTLS_VIEW.log
                kv="\${DATE}=${DATE}"
...
#                file_name=".${DATE}_TBL_ORDER_DTLS_VIEW_${hour}_30_0${anum}.gz"
#                log_file=${DATE}_TBL_ORDER_DTLS_VIEW_${hour}_30_0${anum}.log
