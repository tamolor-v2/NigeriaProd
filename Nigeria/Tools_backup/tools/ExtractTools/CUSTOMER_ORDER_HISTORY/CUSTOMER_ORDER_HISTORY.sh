...
rm -r /nas/share05/tools/ExtractTools/CUSTOMER_ORDER_HISTORY/logs/${removeDir}
...
bash /nas/share05/tools/ExtractTools/scripts/replaceDump.sh CUSTOMER_ORDER_HISTORY ${yest}  


bash /nas/share05/tools/ExtractTools/CUSTOMER_ORDER_HISTORY/driver.sh /nas/share05/tools/ExtractTools/CUSTOMER_ORDER_HISTORY /nas/share05/tools/ExtractTools/CUSTOMER_ORDER_HISTORY/tmp $yest 
retVal=$?
if [ $retVal -eq 0 ];
then
mv /nas/share05/tools/ExtractTools/CUSTOMER_ORDER_HISTORY/tmp/$yest /mnt/beegfs_bsl/live/DB_extract_lz/CUSTOMER_ORDER_HISTORY/incoming
retVal=$?
if [ $retVal -eq 0 ];
then
