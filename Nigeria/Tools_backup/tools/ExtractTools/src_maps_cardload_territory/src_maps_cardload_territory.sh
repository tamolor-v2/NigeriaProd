...
#rm -r /mnt/beegfs_bsl/tools/ExtractTools/src_maps_cardload_territory/logs/${removeDir}
...
bash /mnt/beegfs_bsl/tools/ExtractTools/src_maps_cardload_territory/driver.sh /mnt/beegfs_bsl/tools/ExtractTools/src_maps_cardload_territory /mnt/beegfs_bsl/tools/ExtractTools/src_maps_cardload_territory/tmp $yest 
retVal=$?
if [ $retVal -eq 0 ];
then
mv /mnt/beegfs_bsl/tools/ExtractTools/src_maps_cardload_territory/tmp/$yest /mnt/beegfs_bsl/live/DB_extract_lz/src_maps_cardload_territory/incoming
retVal=$?
if [ $retVal -eq 0 ];
then
