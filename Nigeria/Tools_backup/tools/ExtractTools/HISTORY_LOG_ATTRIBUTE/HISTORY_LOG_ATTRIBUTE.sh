...
rm -r /nas/share05/tools/ExtractTools/HISTORY_LOG_ATTRIBUTE/logs/${removeDir}
...
bash /nas/share05/tools/ExtractTools/scripts/replaceDump.sh HISTORY_LOG_ATTRIBUTE ${yest}
...
bash /nas/share05/tools/ExtractTools/HISTORY_LOG_ATTRIBUTE/driver.sh /nas/share05/tools/ExtractTools/HISTORY_LOG_ATTRIBUTE /nas/share05/tools/ExtractTools/HISTORY_LOG_ATTRIBUTE/tmp $yest 
retVal=$?
if [ $retVal -eq 0 ];
then
mv /nas/share05/tools/ExtractTools/HISTORY_LOG_ATTRIBUTE/tmp/$yest /mnt/beegfs_bsl/live/DB_extract_lz/HISTORY_LOG_ATTRIBUTE/incoming
retVal=$?
if [ $retVal -eq 0 ];
then
