...
bash /nas/share05/tools/ExtractTools/scripts/replaceDump.sh CB_RETAIL_OUTLETS ${yest}  


bash /nas/share05/tools/ExtractTools/CB_RETAIL_OUTLETS/driver.sh /nas/share05/tools/ExtractTools/CB_RETAIL_OUTLETS /nas/share05/tools/ExtractTools/CB_RETAIL_OUTLETS/tmp $yest 
retVal=$?
if [ $retVal -eq 0 ];
then
mv /nas/share05/tools/ExtractTools/CB_RETAIL_OUTLETS/tmp/$yest /mnt/beegfs_bsl/live/DB_extract_lz/CB_RETAIL_OUTLETS/incoming
retVal=$?
if [ $retVal -eq 0 ];
then
