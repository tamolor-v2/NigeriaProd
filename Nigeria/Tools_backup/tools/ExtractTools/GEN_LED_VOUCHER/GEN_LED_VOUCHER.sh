...
rm -r /nas/share05/tools/ExtractTools/GEN_LED_VOUCHER/logs/${removeDir}
...
bash /nas/share05/tools/ExtractTools/GEN_LED_VOUCHER/driver.sh /nas/share05/tools/ExtractTools/GEN_LED_VOUCHER /nas/share05/tools/ExtractTools/GEN_LED_VOUCHER/tmp $yest "0"
retVal=$?
if [ $retVal -eq 0 ];
then
mv /nas/share05/tools/ExtractTools/GEN_LED_VOUCHER/tmp/$yest /mnt/beegfs_bsl/live/DB_extract_lz/GEN_LED_VOUCHER/incoming
retVal=$?
if [ $retVal -eq 0 ];
then
