...
bash /nas/share05/tools/ExtractTools/BILL_SUMMARY_REP_MON/driver.sh /mnt/beegfs_bsl/tools/ExtractTools/BILL_SUMMARY_REP_MON /mnt/beegfs_bsl/tools/ExtractTools/BILL_SUMMARY_REP_MON/tmp $yest 
retVal=$?
if [ $retVal -eq 0 ];
then
