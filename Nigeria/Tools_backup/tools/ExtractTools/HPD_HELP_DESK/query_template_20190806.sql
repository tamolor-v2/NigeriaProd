...
WHERE Incident_Number IS NOT NULL
      AND TRUNC(Reported_Date) >= (TO_DATE('${DATE}', 'yyyymmdd') - TO_DATE('01-JAN-1970', 'DD-MON-YYYY') ) * (86400)
      AND TRUNC(Reported_Date) < ((TO_DATE('${DATE}', 'yyyymmdd')+1) - TO_DATE('01-JAN-1970', 'DD-MON-YYYY') ) * (86400)