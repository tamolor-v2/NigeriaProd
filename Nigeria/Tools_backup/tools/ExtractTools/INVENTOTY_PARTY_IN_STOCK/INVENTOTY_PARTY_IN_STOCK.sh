...
rm -r /nas/share05/tools/ExtractTools/INVENTOTY_PARTY_IN_STOCK/logs/${removeDir}
...
bash /nas/share05/tools/ExtractTools/scripts/replaceDump.sh INVENTORY_PART_IN_STOCK ${yest} ${yest}

bash /nas/share05/tools/ExtractTools/INVENTOTY_PARTY_IN_STOCK/driver.sh /nas/share05/tools/ExtractTools/INVENTOTY_PARTY_IN_STOCK /nas/share05/tools/ExtractTools/INVENTOTY_PARTY_IN_STOCK/tmp $yest 
retVal=$?
if [ $retVal -eq 0 ];
then
mv /nas/share05/tools/ExtractTools/INVENTOTY_PARTY_IN_STOCK/tmp/$yest /mnt/beegfs_bsl/live/DB_extract_lz/INVENTORY_PART_IN_STOCK/incoming
retVal=$?
if [ $retVal -eq 0 ];
then
