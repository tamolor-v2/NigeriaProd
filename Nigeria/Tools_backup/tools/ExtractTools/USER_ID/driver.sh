...
#                kv="\${date}=${DATE};\${hour}=${hour};\${minS}=00;\${minE}=29;\${anum}=${anum}"
                file_name=".${DATE}_USER_ID_${msisdn}.gz"
                log_file=${DATE}_${msisdn}_USER_ID.log
#                kv="\${DATE}=${DATE}"
...
#                file_name=".${DATE}_USER_ID_${hour}_30_0${anum}.gz"
#                log_file=${DATE}_USER_ID_${hour}_30_0${anum}.log
