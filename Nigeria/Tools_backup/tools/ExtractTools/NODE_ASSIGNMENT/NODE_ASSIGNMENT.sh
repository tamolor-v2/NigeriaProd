...
rm -r /nas/share05/tools/ExtractTools/NODE_ASSIGNMENT/logs/${removeDir}
...
bash /nas/share05/tools/ExtractTools/scripts/replaceDump.sh NODE_ASSIGNMENT ${yest}  


bash /nas/share05/tools/ExtractTools/NODE_ASSIGNMENT/driver.sh /nas/share05/tools/ExtractTools/NODE_ASSIGNMENT /nas/share05/tools/ExtractTools/NODE_ASSIGNMENT/tmp $yest 
retVal=$?
if [ $retVal -eq 0 ];
then
mv /nas/share05/tools/ExtractTools/NODE_ASSIGNMENT/tmp/$yest /mnt/beegfs_bsl/live/DB_extract_lz/NODE_ASSIGNMENT/incoming
retVal=$?
if [ $retVal -eq 0 ];
then
