...
#                kv="\${date}=${DATE};\${hour}=${hour};\${minS}=00;\${minE}=29;\${anum}=${anum}"
                file_name=".${DATE}_AYA_CONNECT_DEACTIVATE.gz"
                log_file=${DATE}_AYA_CONNECT_DEACTIVATE.log
                kv="\${DATE}=${DATE}"
...
#                file_name=".${DATE}_CONNECT_DEACTIVATE_${hour}_30_0${anum}.gz"
#                log_file=${DATE}_CONNECT_DEACTIVATE_${hour}_30_0${anum}.log
