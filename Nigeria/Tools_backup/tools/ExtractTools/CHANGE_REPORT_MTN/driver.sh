...
#                echo "work on anum: ${anum}"
                ...
                kv="\${DATE}=${DATE};"
                file_name="${DATE}_CHANGE_REPORT_MTN.gz"
                log_file=${DATE}_CHANGE_REPORT_MTN.log
...
#                file_name=".${DATE}CHANGE_REPORT_MTN_${hour}_30_0${anum}.gz"
#                log_file=${DATE}CHANGE_REPORT_MTN_${hour}_30_0${anum}.log
