...
#                kv="\${date}=${DATE};\${hour}=${hour};\${minS}=00;\${minE}=29;\${anum}=${anum}"
                file_name=".${DATE}_AYA_Aya_test.gz"
                log_file=${DATE}_AYA_Aya_test.log
                kv="\${DATE}=${DATE}"
...
#                file_name=".${DATE}_Aya_test_${hour}_30_0${anum}.gz"
#                log_file=${DATE}_Aya_test_${hour}_30_0${anum}.log
