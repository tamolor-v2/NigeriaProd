...
rm -r /nas/share05/tools/ExtractTools/IDENTITY_INVOICE_INFO/logs/${removeDir}
...
bash /nas/share05/tools/ExtractTools/IDENTITY_INVOICE_INFO/driver.sh /nas/share05/tools/ExtractTools/IDENTITY_INVOICE_INFO /nas/share05/tools/ExtractTools/IDENTITY_INVOICE_INFO/tmp $yest 
retVal=$?
if [ $retVal -eq 0 ];
then
mv /nas/share05/tools/ExtractTools/IDENTITY_INVOICE_INFO/tmp/$yest /mnt/beegfs_bsl/live/DB_extract_lz/IDENTITY_INVOICE_INFO/incoming
retVal=$?
if [ $retVal -eq 0 ];
then
