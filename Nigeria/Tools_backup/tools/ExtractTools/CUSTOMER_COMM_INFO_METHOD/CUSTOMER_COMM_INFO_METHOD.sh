...
rm -r /nas/share05/tools/ExtractTools/CUSTOMER_COMM_INFO_METHOD/logs/${removeDir}
...
bash /nas/share05/tools/ExtractTools/scripts/replaceDump.sh CUSTOMER_INFO_COMM_METHOD ${yest} ${yest}

bash /nas/share05/tools/ExtractTools/CUSTOMER_COMM_INFO_METHOD/driver.sh /nas/share05/tools/ExtractTools/CUSTOMER_COMM_INFO_METHOD /nas/share05/tools/ExtractTools/CUSTOMER_COMM_INFO_METHOD/tmp $yest 
retVal=$?
if [ $retVal -eq 0 ];
then
mv /nas/share05/tools/ExtractTools/CUSTOMER_COMM_INFO_METHOD/tmp/$yest /mnt/beegfs_bsl/live/DB_extract_lz/CUSTOMER_INFO_COMM_METHOD/incoming
retVal=$?
if [ $retVal -eq 0 ];
then
