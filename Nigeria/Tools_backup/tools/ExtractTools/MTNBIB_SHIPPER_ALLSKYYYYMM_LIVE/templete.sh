...
cd /nas/share05/tools/ExtractTools/MTNBIB_SHIPPER_ALLSKYYYYMM_LIVE/spool
...
#start_date=$1
#end_date=$2
file=/nas/share05/tools/ExtractTools/MTNBIB_SHIPPER_ALLSKYYYYMM_LIVE/staging/maxSeq.txt
yyyymmdd=`date  "+%Y%m%d"`
...
PRICE_UNIT||'|'||
COST
from ifsapp.MTNBIB_SHIPPER_ALLSK$month_to_run
...
DIRECTORY="hdfs://ngdaas/FlareData/output_8/MTNBIB_SHIPPER_ALLSKYYYYMM_LIVE/tbl_dt=${tbl_dt}01/"
full_path="${DIRECTORY}*"
...
hadoop fs -mkdir -p /FlareData/output_8/MTNBIB_SHIPPER_ALLSKYYYYMM_LIVE/tbl_dt=${tbl_dt}01
echo "hadoop fs -mkdir -p /FlareData/output_8/MTNBIB_SHIPPER_ALLSKYYYYMM_LIVE/tbl_dt=${tbl_dt}01"
hadoop fs -put "$filename.gz" /FlareData/output_8/MTNBIB_SHIPPER_ALLSKYYYYMM_LIVE/tbl_dt=${tbl_dt}01
echo "hadoop fs -put $filename.gz /FlareData/output_8/MTNBIB_SHIPPER_ALLSKYYYYMM_LIVE/tbl_dt=${tbl_dt}01"
