...
#end_date=$2
file=nas/share05/tools/ExtractTools/MTNBIB_SHIPPER_ALLSKYYYYMM_LIVE/staging/maxSeq.txt
yyyymmdd=${month_to_run}01
filename="MTNBIB_SHIPPER_ALLSKYYYYMM_LIVE_"$yyyymmdd"_"$tbl_dt"01.csv"
...
do
   ...
   bash /nas/share05/tools/ExtractTools/MTNBIB_SHIPPER_ALLSKYYYYMM_LIVE/templete.sh $i $month_to_run
