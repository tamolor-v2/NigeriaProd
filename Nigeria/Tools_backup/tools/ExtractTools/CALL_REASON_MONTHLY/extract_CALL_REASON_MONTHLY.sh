...
bash /nas/share05/tools/ExtractTools/CALL_REASON_MONTHLY/driver_CALL_REASON_MONTHLY.sh /nas/share05/tools/ExtractTools/CALL_REASON_MONTHLY /mnt/beegfs_bsl/FlareData/CDR/CALL_REASON_MONTHLY/tmp/ $yest "0"
retVal=$?
if [ $retVal -eq 0 ];
then
