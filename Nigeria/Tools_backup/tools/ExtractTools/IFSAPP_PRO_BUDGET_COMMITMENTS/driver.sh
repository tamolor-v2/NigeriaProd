...
#                echo "work on anum: ${anum}"
                ...
                kv="\${DATE}=${DATE}"
                file_name="${DATE}_IFSAPP_PRO_BUDGET_COMMITMENTS.gz"
                log_file=${DATE}_IFSAPP_PRO_BUDGET_COMMITMENTS.log
...
#                file_name=".${DATE}IFSAPP_PRO_BUDGET_COMMITMENTS_${hour}_30_0${anum}.gz"
#                log_file=${DATE}IFSAPP_PRO_BUDGET_COMMITMENTS_${hour}_30_0${anum}.log
