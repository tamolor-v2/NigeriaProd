...
cd ${WORK_DIR}
        for anum in "${A_NUM_FILTER[@]}"; do
                ...
                command="bash /home/daasuser/JDBC_Tool/JDBCExtract.scala --configFile ${WORK_DIR}/config.properties --sqlFile ${WORK_DIR}/INC_query_template_20191203.sql --outputFile ${output_dir}/${file_name} --delimiter ${DELIMITER} --kvTemplate ${kv}"
