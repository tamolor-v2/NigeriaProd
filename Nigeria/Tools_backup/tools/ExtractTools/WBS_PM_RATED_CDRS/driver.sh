...
for hour in "${HOURS[@]}"; do
        ...
        for anum in "${A_NUM_FILTER[@]}"; do
                ...
                file_name=".${DATE}_WBS_PM_RATED_CDRS_${hour}_00_0${anum}.gz"
                log_file=${DATE}_WBS_PM_RATED_CDRS_${hour}_00_0${anum}.log
                ...
                file_name=".${DATE}_WBS_PM_RATED_CDRS_${hour}_30_0${anum}.gz"
                log_file=${DATE}_WBS_PM_RATED_CDRS_${hour}_30_0${anum}.log
