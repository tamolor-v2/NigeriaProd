...
cd ${WORK_DIR}
        for anum in "${A_NUM_FILTER[@]}"; do
                ...
                command="bash /home/daasuser/JDBC_Tool/JDBCExtract.scala --configFile ${WORK_DIR}/config_20191203.properties --sqlFile ${WORK_DIR}/INC_query_template_20190417.sql --outputFile ${output_dir}/${file_name} --delimiter ${DELIMITER} --kvTemplate ${kv}"
