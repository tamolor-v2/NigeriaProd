...
maxSeq=$prevMaxSeq
echo "max_seq=$maxSeq"
maxSeq=20191207000000
currMaxSeq=20191208000000
bash /nas/share05/tools/ExtractTools/WBS_PM_RATED_CDRS/INC_driver_localJar_20190417.sh /nas/share05/tools/ExtractTools/WBS_PM_RATED_CDRS /nas/share05/FlareProd/Working2/WBS_PM_RATED_CDRS/ $yest  "1 3 4 5 6 7 9" $maxSeq $currMaxSeq
