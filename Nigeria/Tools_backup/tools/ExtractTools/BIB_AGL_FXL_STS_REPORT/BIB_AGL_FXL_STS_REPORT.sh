...
rm -r /mnt/beegfs_bsl/tools/ExtractTools/BIB_AGL_FXL_STS_REPORT/logs/${removeDir}
...
bash /nas/share05/tools/ExtractTools/BIB_AGL_FXL_STS_REPORT/driver.sh /mnt/beegfs_bsl/tools/ExtractTools/BIB_AGL_FXL_STS_REPORT /mnt/beegfs_bsl/tools/ExtractTools/BIB_AGL_FXL_STS_REPORT/tmp $yest 
retVal=$?
if [ $retVal -eq 0 ];
then
mv /mnt/beegfs_bsl/tools/ExtractTools/BIB_AGL_FXL_STS_REPORT/tmp/$yest /mnt/beegfs_bsl/live/DB_extract_lz/BIB_AGL_FXL_STS_REPORT/incoming/
retVal=$?
if [ $retVal -eq 0 ];
then
