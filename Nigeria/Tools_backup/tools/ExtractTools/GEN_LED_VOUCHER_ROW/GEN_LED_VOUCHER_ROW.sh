...
rm -r /nas/share05/tools/ExtractTools/GEN_LED_VOUCHER_ROW/logs/${removeDir}
...
bash /nas/share05/tools/ExtractTools/GEN_LED_VOUCHER_ROW/driver.sh /nas/share05/tools/ExtractTools/GEN_LED_VOUCHER_ROW /nas/share05/tools/ExtractTools/GEN_LED_VOUCHER_ROW/tmp/Omar $yest 
retVal=$?
if [ $retVal -eq 0 ];
then
mv /nas/share05/tools/ExtractTools/GEN_LED_VOUCHER_ROW/tmp/$yest /mnt/beegfs_bsl/live/DB_extract_lz/GEN_LED_VOUCHER_ROW/incoming
retVal=$?
if [ $retVal -eq 0 ];
then
