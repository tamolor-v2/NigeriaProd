...
bash /nas/share05/tools/ExtractTools/scripts/replaceDump.sh BLACKLIST_HISTORY ${yest}  


bash /nas/share05/tools/ExtractTools/BLACKLIST_HISTORY/driver.sh /nas/share05/tools/ExtractTools/BLACKLIST_HISTORY /nas/share05/tools/ExtractTools/BLACKLIST_HISTORY/tmp $yest 
retVal=$?
if [ $retVal -eq 0 ];
then
mv /nas/share05/tools/ExtractTools/BLACKLIST_HISTORY/tmp/$yest /mnt/beegfs_bsl/live/DB_extract_lz/BLACKLIST_HISTORY/incoming
retVal=$?
if [ $retVal -eq 0 ];
then
