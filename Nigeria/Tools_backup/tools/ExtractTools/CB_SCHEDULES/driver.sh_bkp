...
#                echo "work on anum: ${anum}"
                ...
                # hour
                kv="\${DATE}=${DATE};"
                file_name="${DATE}_CB_SCHEDULES.gz"
                log_file=${DATE}CB_SCHEDULES.log
...
#                file_name=".${DATE}CB_SCHEDULES${hour}_30_0${anum}.gz"
#                log_file=${DATE}CB_SCHEDULES${hour}_30_0${anum}.log
