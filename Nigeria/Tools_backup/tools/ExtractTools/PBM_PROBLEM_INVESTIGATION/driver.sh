...
#                echo "work on anum: ${anum}"
                ...
                kv="\${DATE}=${DATE}"
                file_name="${DATE}PBM_PROBLEM_INVESTIGATION.gz"
                log_file=${DATE}PBM_PROBLEM_INVESTIGATION.log
...
#                file_name=".${DATE}PBM_PROBLEM_INVESTIGATION_${hour}_30_0${anum}.gz"
#                log_file=${DATE}PBM_PROBLEM_INVESTIGATION_${hour}_30_0${anum}.log
