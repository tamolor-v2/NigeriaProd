...
rm -r /nas/share05/tools/ExtractTools/KM_USER/logs/${removeDir}
...
bash /nas/share05/tools/ExtractTools/scripts/replaceDump.sh KM_USER ${yest}  


bash /nas/share05/tools/ExtractTools/KM_USER/driver.sh /nas/share05/tools/ExtractTools/KM_USER /nas/share05/tools/ExtractTools/KM_USER/tmp $yest 
retVal=$?
if [ $retVal -eq 0 ];
then
mv /nas/share05/tools/ExtractTools/KM_USER/tmp/$yest /mnt/beegfs_bsl/live/DB_extract_lz/KM_USER/incoming
retVal=$?
if [ $retVal -eq 0 ];
then
