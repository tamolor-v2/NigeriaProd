...
bash /nas/share05/tools/ExtractTools/scripts/replaceDump.sh PAYMENT_TERM ${yest}  


bash /nas/share05/tools/ExtractTools/PAYMENT_TERM/driver.sh /nas/share05/tools/ExtractTools/PAYMENT_TERM /nas/share05/tools/ExtractTools/PAYMENT_TERM/tmp $yest 
retVal=$?
if [ $retVal -eq 0 ];
then
mv /nas/share05/tools/ExtractTools/PAYMENT_TERM/tmp/$yest /mnt/beegfs_bsl/live/DB_extract_lz/PAYMENT_TERM/incoming
retVal=$?
if [ $retVal -eq 0 ];
then
