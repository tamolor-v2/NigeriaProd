...
bash /nas/share05/tools/ExtractTools/SMS_INCENTIVE_IMEI_VW/driver.sh /mnt/beegfs_bsl/tools/ExtractTools/SMS_INCENTIVE_IMEI_VW /mnt/beegfs_bsl/tools/ExtractTools/SMS_INCENTIVE_IMEI_VW/tmp $yest "00" "0" $yest 
retVal=$?
if [ $retVal -eq 0 ];
then
