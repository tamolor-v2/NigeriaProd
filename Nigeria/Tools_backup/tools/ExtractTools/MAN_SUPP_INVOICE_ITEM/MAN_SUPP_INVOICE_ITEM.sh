...
rm -r /nas/share05/tools/ExtractTools/MAN_SUPP_INVOICE_ITEM/logs/${removeDir}
...
bash /nas/share05/tools/ExtractTools/scripts/replaceDump.sh MAN_SUPP_INVOICE_ITEM ${yest}
...
bash /nas/share05/tools/ExtractTools/MAN_SUPP_INVOICE_ITEM/driver.sh /nas/share05/tools/ExtractTools/MAN_SUPP_INVOICE_ITEM /nas/share05/tools/ExtractTools/MAN_SUPP_INVOICE_ITEM/tmp/ $yest 
retVal=$?
if [ $retVal -eq 0 ];
then
mv /nas/share05/tools/ExtractTools/MAN_SUPP_INVOICE_ITEM/tmp/$yest /mnt/beegfs_bsl/live/DB_extract_lz/MAN_SUPP_INVOICE_ITEM/incoming
retVal=$?
if [ $retVal -eq 0 ];
then
