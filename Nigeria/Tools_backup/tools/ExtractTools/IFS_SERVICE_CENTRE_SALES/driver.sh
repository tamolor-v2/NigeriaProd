...
kv="\${DATE}=${DATE};"
file_name="${DATE}_IFS_SERVICE_CENTRE_SALES.gz"
log_file=${DATE}_IFS_SERVICE_CENTRE_SALES.log
...
#     echo "starting command: ${command}"
#     nohup  ${command} >  ${log_dir}/${log_file}  2>&1 &
#     # mv ${output_dir} /mnt/beegfs_bsl/live/DB_extract_lz/IFS_SERVICE_CENTRE_SALES/incoming/
#     ((day++))
