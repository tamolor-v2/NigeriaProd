...
#                echo "work on anum: ${anum}"
                ...
                kv="\${DATE}=${DATE}"
                file_name="${DATE}_IFSAPP_MTN_RECEIPT_RECONC_RPT.gz"
                log_file=${DATE}_IFSAPP_MTN_RECEIPT_RECONC_RPT.log
...
#                file_name=".${DATE}IFSAPP_MTN_RECEIPT_RECONC_RPT_${hour}_30_0${anum}.gz"
#                log_file=${DATE}IFSAPP_MTN_RECEIPT_RECONC_RPT_${hour}_30_0${anum}.log
