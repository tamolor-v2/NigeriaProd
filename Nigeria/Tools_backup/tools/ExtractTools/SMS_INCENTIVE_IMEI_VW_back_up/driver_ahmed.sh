...
for hour in "${HOURS[@]}"; do
        ...
        for anum in "${A_NUM_FILTER[@]}"; do
                ...
                command="bash ${WORK_DIR}/JDBCExtract.scala --configFile ${WORK_DIR}/config.properties --sqlFile ${WORK_DIR}/query_template_ahmed.sql --outputFile ${output_dir}/${file_name} --delimiter ${DELIMITER} --kvTemplate ${kv}"
