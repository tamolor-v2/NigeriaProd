...
rm -r /nas/share05/tools/ExtractTools/PURCHASE_ORDER_LINE/logs/${removeDir}
...
bash /nas/share05/tools/ExtractTools/scripts/replaceDump.sh PURCHASE_ORDER_LINE ${yest}  


bash /nas/share05/tools/ExtractTools/PURCHASE_ORDER_LINE/driver.sh /nas/share05/tools/ExtractTools/PURCHASE_ORDER_LINE /nas/share05/tools/ExtractTools/PURCHASE_ORDER_LINE/tmp $yest 
retVal=$?
if [ $retVal -eq 0 ];
then
mv /nas/share05/tools/ExtractTools/PURCHASE_ORDER_LINE/tmp/$yest /mnt/beegfs_bsl/live/DB_extract_lz/PURCHASE_ORDER_LINE/incoming
retVal=$?
if [ $retVal -eq 0 ];
then
