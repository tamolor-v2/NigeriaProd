...
rm -r /nas/share05/tools/ExtractTools/CUSTOMER_ORDER_TYPE/logs/${removeDir}
...
bash /nas/share05/tools/ExtractTools/scripts/replaceDump.sh CUST_ORDER_TYPE ${yest} ${yest}

bash /nas/share05/tools/ExtractTools/CUSTOMER_ORDER_TYPE/driver.sh /nas/share05/tools/ExtractTools/CUSTOMER_ORDER_TYPE /nas/share05/tools/ExtractTools/CUSTOMER_ORDER_TYPE/tmp $yest 
retVal=$?
if [ $retVal -eq 0 ];
then
mv /nas/share05/tools/ExtractTools/CUSTOMER_ORDER_TYPE/tmp/$yest /mnt/beegfs_bsl/live/DB_extract_lz/CUST_ORDER_TYPE/incoming
retVal=$?
if [ $retVal -eq 0 ];
then
