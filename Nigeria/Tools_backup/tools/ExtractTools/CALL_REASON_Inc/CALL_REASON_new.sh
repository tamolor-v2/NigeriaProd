...
### push to kafka here
yest=$(date -d '-9 day' '+%Y%m%d')
removeDir=$(date -d '-60 day' '+%Y%m%d')
emailReceiver=$(cat /mnt/beegfs/tools/Crontab/Scripts/email.dat)
rm -r /mnt/beegfs_bsl/tools/ExtractTools/CALL_REASON_Inc/logs/${removeDir}
...
bash /nas/share05/tools/ExtractTools/CALL_REASON_Inc/driver.sh /nas/share05/tools/ExtractTools/CALL_REASON_Inc /nas/share05/tools/ExtractTools/CALL_REASON_Inc/tmp/ $yest 
retVal=$?
if [ $retVal -eq 0 ];
then
#mv /nas/share05/tools/ExtractTools/CALL_REASON_Inc/tmp/$yest /mnt/beegfs_bsl/live/DB_extract_lz/CALL_REASON_Inc/incoming
retVal=$?
if [ $retVal -eq 0 ];
then
