...
bash /nas/share05/tools/ExtractTools/CB_POS_TRANSACTIONS/driver.sh /nas/share05/tools/ExtractTools/CB_POS_TRANSACTIONS /nas/share05/tools/ExtractTools/CB_POS_TRANSACTIONS/tmp
retVal=$?
if [ $retVal -eq 0 ];
then
