...
rm -r /nas/share05/tools/ExtractTools/PRICE_LIST/logs/${removeDir}
...
bash /nas/share05/tools/ExtractTools/scripts/replaceDump.sh PRICE_LIST ${yest} ${yest}
bash /nas/share05/tools/ExtractTools/PRICE_LIST/driver.sh /nas/share05/tools/ExtractTools/PRICE_LIST /nas/share05/tools/ExtractTools/PRICE_LIST/tmp $yest 
retVal=$?
if [ $retVal -eq 0 ];
then
mv /nas/share05/tools/ExtractTools/PRICE_LIST/tmp/$yest /mnt/beegfs_bsl/live/DB_extract_lz/PRICE_LIST/incoming
retVal=$?
if [ $retVal -eq 0 ];
then
