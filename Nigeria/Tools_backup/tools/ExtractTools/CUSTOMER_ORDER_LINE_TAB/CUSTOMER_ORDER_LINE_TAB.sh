...
rm -r /nas/share05/tools/ExtractTools/CUSTOMER_ORDER_LINE_TAB/logs/${removeDir}
...
bash /nas/share05/tools/ExtractTools/scripts/replaceDump.sh CUSTOMER_ORDER_LINE_TAB ${yest}  


bash /nas/share05/tools/ExtractTools/CUSTOMER_ORDER_LINE_TAB/driver.sh /nas/share05/tools/ExtractTools/CUSTOMER_ORDER_LINE_TAB /nas/share05/tools/ExtractTools/CUSTOMER_ORDER_LINE_TAB/tmp $yest 
retVal=$?
if [ $retVal -eq 0 ];
then
mv /nas/share05/tools/ExtractTools/CUSTOMER_ORDER_LINE_TAB/tmp/$yest /mnt/beegfs_bsl/live/DB_extract_lz/CUSTOMER_ORDER_LINE_TAB/incoming
retVal=$?
if [ $retVal -eq 0 ];
then
