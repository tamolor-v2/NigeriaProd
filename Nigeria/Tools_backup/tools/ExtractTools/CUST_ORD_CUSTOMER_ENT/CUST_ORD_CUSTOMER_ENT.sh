...
rm -r /nas/share05/tools/ExtractTools/CUST_ORD_CUSTOMER_ENT/logs/${removeDir}
...
bash /nas/share05/tools/ExtractTools/scripts/replaceDump.sh CUST_ORD_CUSTOMER_ENT ${yest}  


bash /nas/share05/tools/ExtractTools/CUST_ORD_CUSTOMER_ENT/driver.sh /nas/share05/tools/ExtractTools/CUST_ORD_CUSTOMER_ENT /nas/share05/tools/ExtractTools/CUST_ORD_CUSTOMER_ENT/tmp $yest 
retVal=$?
if [ $retVal -eq 0 ];
then
mv /nas/share05/tools/ExtractTools/CUST_ORD_CUSTOMER_ENT/tmp/$yest /mnt/beegfs_bsl/live/DB_extract_lz/CUST_ORD_CUSTOMER_ENT/incoming
retVal=$?
if [ $retVal -eq 0 ];
then
