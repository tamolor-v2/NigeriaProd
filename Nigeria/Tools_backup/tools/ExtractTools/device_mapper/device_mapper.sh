...
rm -r /mnt/beegfs_bsl/tools/ExtractTools/device_mapper/logs/${removeDir}
...
bash /mnt/beegfs_bsl/tools/ExtractTools/device_mapper/driver.sh /mnt/beegfs_bsl/tools/ExtractTools/device_mapper /mnt/beegfs_bsl/tools/ExtractTools/device_mapper/tmp/Aya $yest 
retVal=$?
if [ $retVal -eq 0 ];
then
mv /mnt/beegfs_bsl/tools/ExtractTools/device_mapper/tmp/$yest /mnt/beegfs_bsl/live/DB_extract_lz/device_mapper/incoming
retVal=$?
if [ $retVal -eq 0 ];
then
