...
rm -r /nas/share05/tools/ExtractTools/PAYMENT_PLAN_AUTH/logs/${removeDir}
...
bash /nas/share05/tools/ExtractTools/scripts/replaceDump.sh PAYMENT_PLAN_AUTH ${yest}
...
bash /nas/share05/tools/ExtractTools/PAYMENT_PLAN_AUTH/driver.sh /nas/share05/tools/ExtractTools/PAYMENT_PLAN_AUTH /nas/share05/tools/ExtractTools/PAYMENT_PLAN_AUTH/tmp $yest 
retVal=$?
if [ $retVal -eq 0 ];
then
mv /nas/share05/tools/ExtractTools/PAYMENT_PLAN_AUTH/tmp/$yest /mnt/beegfs_bsl/live/DB_extract_lz/PAYMENT_PLAN_AUTH/incoming
retVal=$?
if [ $retVal -eq 0 ];
then
