...
bash /mnt/beegfs_bsl/tools/ExtractTools/cardload_report_daily/driver.sh /mnt/beegfs_bsl/tools/ExtractTools/cardload_report_daily /mnt/beegfs_bsl/tools/ExtractTools/cardload_report_daily/tmp $yest 
retVal=$?
if [ $retVal -eq 0 ];
then
mv /mnt/beegfs_bsl/tools/ExtractTools/cardload_report_daily/tmp/$yest /mnt/beegfs_bsl/live/DB_extract_lz/cardload_report_daily/incoming
retVal=$?
if [ $retVal -eq 0 ];
then
