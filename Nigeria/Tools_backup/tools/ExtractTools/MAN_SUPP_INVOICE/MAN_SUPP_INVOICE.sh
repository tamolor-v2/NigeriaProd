...
rm -r /nas/share05/tools/ExtractTools/MAN_SUPP_INVOICE/logs/${removeDir}
...
bash /nas/share05/tools/ExtractTools/scripts/replaceDump.sh MAN_SUPP_INVOICE ${yest}
...
bash /nas/share05/tools/ExtractTools/MAN_SUPP_INVOICE/driver.sh /nas/share05/tools/ExtractTools/MAN_SUPP_INVOICE /nas/share05/tools/ExtractTools/MAN_SUPP_INVOICE/tmp $yest 
retVal=$?
if [ $retVal -eq 0 ];
then
mv /nas/share05/tools/ExtractTools/MAN_SUPP_INVOICE/tmp/$yest /mnt/beegfs_bsl/live/DB_extract_lz/MAN_SUPP_INVOICE/incoming
retVal=$?
if [ $retVal -eq 0 ];
then
