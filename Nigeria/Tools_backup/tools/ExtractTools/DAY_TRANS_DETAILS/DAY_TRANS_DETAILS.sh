...
rm -r /nas/share05/tools/ExtractTools/DAY_TRANS_DETAILS/logs/${removeDir}
...
bash /nas/share05/tools/ExtractTools/scripts/replaceDump.sh DAY_TRANS_DETAIL ${yest} ${yest}

bash /nas/share05/tools/ExtractTools/DAY_TRANS_DETAILS/driver.sh /nas/share05/tools/ExtractTools/DAY_TRANS_DETAILS /nas/share05/tools/ExtractTools/DAY_TRANS_DETAILS/tmp $yest 
retVal=$?
if [ $retVal -eq 0 ];
then
mv /nas/share05/tools/ExtractTools/DAY_TRANS_DETAILS/tmp/$yest /mnt/beegfs_bsl/live/DB_extract_lz/DAY_TRANS_DETAIL/incoming
retVal=$?
if [ $retVal -eq 0 ];
then
