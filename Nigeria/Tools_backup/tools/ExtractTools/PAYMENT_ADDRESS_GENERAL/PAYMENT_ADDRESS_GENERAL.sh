...
bash /nas/share05/tools/ExtractTools/scripts/replaceDump.sh PAYMENT_ADDRESS_GENERAL ${yest} ${yest}
bash /nas/share05/tools/ExtractTools/PAYMENT_ADDRESS_GENERAL/driver.sh /nas/share05/tools/ExtractTools/PAYMENT_ADDRESS_GENERAL /nas/share05/tools/ExtractTools/PAYMENT_ADDRESS_GENERAL/tmp $yest 
retVal=$?
if [ $retVal -eq 0 ];
then
mv /nas/share05/tools/ExtractTools/PAYMENT_ADDRESS_GENERAL/tmp/$yest /mnt/beegfs_bsl/live/DB_extract_lz/PAYMENT_ADDRESS_GENERAL/incoming
retVal=$?
if [ $retVal -eq 0 ];
then
