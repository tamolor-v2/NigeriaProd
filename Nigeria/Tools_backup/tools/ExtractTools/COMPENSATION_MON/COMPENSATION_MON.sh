...
#rm -r /mnt/beegfs_bsl/tools/ExtractTools/COMPENSATION_MON/logs/${removeDir}
...
query_templ="/nas/share05/tools/ExtractTools/COMPENSATION_MON/query_template.sql"
sed -i "s/prevmont/${prevmont}/g" $query_templ
bash /nas/share05/tools/ExtractTools/COMPENSATION_MON/driver.sh /nas/share05/tools/ExtractTools/COMPENSATION_MON /nas/share05/tools/ExtractTools/COMPENSATION_MON/tmp $yest 
sed -i "s/${prevmont}/prevmont/g" $query_templ
retVal=$?
if [ $retVal -eq 0 ];
then
#mv /nas/share05/tools/ExtractTools/COMPENSATION_MON/tmp/$yest /mnt/beegfs_bsl/FlareDataTest/COMPENSATION_MON/incoming
retVal=$?
if [ $retVal -eq 0 ];
then
