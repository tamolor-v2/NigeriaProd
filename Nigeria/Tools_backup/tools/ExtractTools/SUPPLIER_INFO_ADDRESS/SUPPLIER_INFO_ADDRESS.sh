...
bash /nas/share05/tools/ExtractTools/scripts/replaceDump.sh SUPPLIER_INFO_ADDRESS ${yest} ${yest}
bash /nas/share05/tools/ExtractTools/SUPPLIER_INFO_ADDRESS/driver.sh /nas/share05/tools/ExtractTools/SUPPLIER_INFO_ADDRESS /nas/share05/tools/ExtractTools/SUPPLIER_INFO_ADDRESS/tmp $yest 
retVal=$?
if [ $retVal -eq 0 ];
then
mv /nas/share05/tools/ExtractTools/SUPPLIER_INFO_ADDRESS/tmp/$yest /mnt/beegfs_bsl/live/DB_extract_lz/SUPPLIER_INFO_ADDRESS/incoming
retVal=$?
if [ $retVal -eq 0 ];
then
