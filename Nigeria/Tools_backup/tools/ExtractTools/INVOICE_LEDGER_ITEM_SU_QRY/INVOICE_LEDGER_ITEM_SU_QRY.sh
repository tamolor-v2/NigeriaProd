...
rm -r /nas/share05/tools/ExtractTools/INVOICE_LEDGER_ITEM_SU_QRY/logs/${removeDir}
...
bash /nas/share05/tools/ExtractTools/INVOICE_LEDGER_ITEM_SU_QRY/driver.sh /nas/share05/tools/ExtractTools/INVOICE_LEDGER_ITEM_SU_QRY /nas/share05/tools/ExtractTools/INVOICE_LEDGER_ITEM_SU_QRY/tmp/Omar $yest 
retVal=$?
if [ $retVal -eq 0 ];
then
mv /nas/share05/tools/ExtractTools/INVOICE_LEDGER_ITEM_SU_QRY/tmp/$yest /mnt/beegfs_bsl/live/DB_extract_lz/INVOICE_LEDGER_ITEM_SU_QRY/incoming
retVal=$?
if [ $retVal -eq 0 ];
then
