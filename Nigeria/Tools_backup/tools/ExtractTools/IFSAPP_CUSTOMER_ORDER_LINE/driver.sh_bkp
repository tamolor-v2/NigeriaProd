...
#                echo "work on anum: ${anum}"
                ...
                kv="\${DATE}=${DATE}"
                file_name="${DATE}_IFSAPP_CUSTOMER_ORDER_LINE.gz"
                log_file=${DATE}_IFSAPP_CUSTOMER_ORDER_LINE.log
...
#                file_name=".${DATE}IFSAPP_CUSTOMER_ORDER_LINE_${hour}_30_0${anum}.gz"
#                log_file=${DATE}IFSAPP_CUSTOMER_ORDER_LINE_${hour}_30_0${anum}.log
