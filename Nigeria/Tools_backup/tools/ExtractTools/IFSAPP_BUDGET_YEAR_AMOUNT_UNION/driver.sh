...
#                echo "work on anum: ${anum}"
                ...
                kv="\${DATE}=${DATE}"
                file_name="${DATE}_IFSAPP_BUDGET_YEAR_AMOUNT_UNION.gz"
                log_file=${DATE}_IFSAPP_BUDGET_YEAR_AMOUNT_UNION.log
...
#                file_name=".${DATE}IFSAPP_BUDGET_YEAR_AMOUNT_UNION_${hour}_30_0${anum}.gz"
#                log_file=${DATE}IFSAPP_BUDGET_YEAR_AMOUNT_UNION_${hour}_30_0${anum}.log
