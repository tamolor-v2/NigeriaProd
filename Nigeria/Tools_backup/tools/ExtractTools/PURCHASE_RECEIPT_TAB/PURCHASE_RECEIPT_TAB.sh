...
rm -r /nas/share05/tools/ExtractTools/PURCHASE_RECEIPT_TAB/logs/${removeDir}
...
bash /nas/share05/tools/ExtractTools/scripts/replaceDump.sh PURCHASE_RECEIPT_TAB ${yest}  


bash /nas/share05/tools/ExtractTools/PURCHASE_RECEIPT_TAB/driver.sh /nas/share05/tools/ExtractTools/PURCHASE_RECEIPT_TAB /nas/share05/tools/ExtractTools/PURCHASE_RECEIPT_TAB/tmp $yest 
retVal=$?
if [ $retVal -eq 0 ];
then
mv /nas/share05/tools/ExtractTools/PURCHASE_RECEIPT_TAB/tmp/$yest /mnt/beegfs_bsl/live/DB_extract_lz/PURCHASE_RECEIPT_TAB/incoming
retVal=$?
if [ $retVal -eq 0 ];
then
