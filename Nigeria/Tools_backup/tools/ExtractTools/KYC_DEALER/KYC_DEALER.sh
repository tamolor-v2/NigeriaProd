...
rm -r /nas/share05/tools/ExtractTools/KYC_DEALER/logs/${removeDir}
...
bash /nas/share05/tools/ExtractTools/scripts/replaceDump.sh KYC_DEALER ${yest}  


bash /nas/share05/tools/ExtractTools/KYC_DEALER/driver.sh /nas/share05/tools/ExtractTools/KYC_DEALER /nas/share05/tools/ExtractTools/KYC_DEALER/tmp $yest 
retVal=$?
if [ $retVal -eq 0 ];
then
mv /nas/share05/tools/ExtractTools/KYC_DEALER/tmp/$yest /mnt/beegfs_bsl/live/DB_extract_lz/KYC_DEALER/incoming
retVal=$?
if [ $retVal -eq 0 ];
then
