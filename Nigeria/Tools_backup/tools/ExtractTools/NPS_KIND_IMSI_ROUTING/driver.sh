...
#                kv="\${date}=${DATE};\${hour}=${hour};\${minS}=00;\${minE}=29;\${anum}=${anum}"
                file_name=".${DATE}_AYA_NPS_KIND_IMSI_ROUTING.gz"
                log_file=${DATE}_AYA_NPS_KIND_IMSI_ROUTING.log
                kv="\${DATE}=${DATE}"
...
#                file_name=".${DATE}_NPS_KIND_IMSI_ROUTING_${hour}_30_0${anum}.gz"
#                log_file=${DATE}_NPS_KIND_IMSI_ROUTING_${hour}_30_0${anum}.log
