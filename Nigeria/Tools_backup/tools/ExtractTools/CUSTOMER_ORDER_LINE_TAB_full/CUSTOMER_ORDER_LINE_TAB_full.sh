...
rm -r /mnt/beegfs_bsl/tools/ExtractTools/CUSTOMER_ORDER_LINE_TAB_full/logs/${removeDir}
...
#bash /nas/share05/tools/ExtractTools/scripts/replaceDump.sh CUSTOMER_ORDER_LINE_TAB_full ${yest}  


bash /nas/share05/tools/ExtractTools/CUSTOMER_ORDER_LINE_TAB_full/driver.sh /nas/share05/tools/ExtractTools/CUSTOMER_ORDER_LINE_TAB_full /nas/share05/tools/ExtractTools/CUSTOMER_ORDER_LINE_TAB_full/tmp $yest 
retVal=$?
if [ $retVal -eq 0 ];
then
#mv /mnt/beegfs_bsl/tools/ExtractTools/CUSTOMER_ORDER_LINE_TAB_full/tmp/$yest /mnt/beegfs_bsl/live/DB_extract_lz/CUSTOMER_ORDER_LINE_TAB_full/incoming
retVal=$?
if [ $retVal -eq 0 ];
then
