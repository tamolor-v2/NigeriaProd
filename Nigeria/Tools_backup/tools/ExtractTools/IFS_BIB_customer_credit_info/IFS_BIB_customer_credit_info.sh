...
rm -r /mnt/beegfs_bsl/tools/ExtractTools/IFS_BIB_customer_credit_info/logs/${removeDir}
...
bash /mnt/beegfs_bsl/tools/ExtractTools/IFS_BIB_customer_credit_info/driver.sh /mnt/beegfs_bsl/tools/ExtractTools/IFS_BIB_customer_credit_info /mnt/beegfs_bsl/tools/ExtractTools/IFS_BIB_customer_credit_info/tmp/ $yest 
retVal=$?
if [ $retVal -eq 0 ];
then
mv /mnt/beegfs_bsl/tools/ExtractTools/IFS_BIB_customer_credit_info/tmp/$yest /mnt/beegfs_bsl/live/DB_extract_lz/IFS_BIB_customer_credit_info/incoming
retVal=$?
if [ $retVal -eq 0 ];
then
