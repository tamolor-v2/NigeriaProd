...
#                echo "work on anum: ${anum}"
                ...
                kv="\${DATE}=${DATE}"
                file_name="${DATE}_BUDGET_YEAR_AMOUNT.gz"
                log_file=${DATE}_BUDGET_YEAR_AMOUNT.log
...
#                file_name=".${DATE}BUDGET_YEAR_AMOUNT_${hour}_30_0${anum}.gz"
#                log_file=${DATE}BUDGET_YEAR_AMOUNT_${hour}_30_0${anum}.log
