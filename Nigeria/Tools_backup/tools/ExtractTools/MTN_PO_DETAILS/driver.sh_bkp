...
#                echo "work on anum: ${anum}"
                ...
                kv="\${DATE}=${DATE}"
                file_name="${DATE}_MTN_PO_DETAILS.gz"
                log_file=${DATE}_MTN_PO_DETAILS.log
...
#                file_name=".${DATE}MTN_PO_DETAILS_${hour}_30_0${anum}.gz"
#                log_file=${DATE}MTN_PO_DETAILS_${hour}_30_0${anum}.log
