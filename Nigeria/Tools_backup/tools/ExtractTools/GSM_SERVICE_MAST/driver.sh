...
#                echo "work on anum: ${anum}"
                ...
                kv="\${DATE}=${DATE}"
                file_name="${DATE}_GSM_SERVICE_MAST.gz"
                log_file=${DATE}_GSM_SERVICE_MAST.log
...
#                file_name=".${DATE}_GSM_SERVICE_MAST_${hour}_30_0${anum}.gz"
#                log_file=${DATE}_GSM_SERVICE_MAST_${hour}_30_0${anum}.log
