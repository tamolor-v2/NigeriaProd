...
rm -r /nas/share05/tools/ExtractTools/PURCHASE_ORDER/logs/${removeDir}
...
bash /nas/share05/tools/ExtractTools/scripts/replaceDump.sh PURCHASE_ORDER ${yest}  


bash /nas/share05/tools/ExtractTools/PURCHASE_ORDER/driver.sh /nas/share05/tools/ExtractTools/PURCHASE_ORDER /nas/share05/tools/ExtractTools/PURCHASE_ORDER/tmp $yest 
retVal=$?
if [ $retVal -eq 0 ];
then
mv /nas/share05/tools/ExtractTools/PURCHASE_ORDER/tmp/$yest /mnt/beegfs_bsl/live/DB_extract_lz/PURCHASE_ORDER/incoming
retVal=$?
if [ $retVal -eq 0 ];
then
