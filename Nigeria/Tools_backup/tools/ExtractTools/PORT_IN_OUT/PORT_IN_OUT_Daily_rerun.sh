...
rm -r /mnt/beegfs_bsl/tools/ExtractTools/PORT_IN_OUT/logs/${removeDir}
...
bash /nas/share05/tools/ExtractTools/PORT_IN_OUT/driver.sh /nas/share05/tools/ExtractTools/PORT_IN_OUT /nas/share05/tools/ExtractTools/PORT_IN_OUT/tmp/ $yest 
retVal=$?
if [ $retVal -eq 0 ];
then
hdfs dfs -rm /FlareData/output_8/PORT_IN_OUT/tbl_dt=${yest}/*
mv /nas/share05/tools/ExtractTools/PORT_IN_OUT/tmp/$yest /mnt/beegfs_bsl/live/DB_extract_lz/PORT_IN_OUT/incoming
retVal=$?
if [ $retVal -eq 0 ];
then
