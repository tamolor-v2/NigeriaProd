...
rm -r /mnt/beegfs_bsl/tools/ExtractTools/PURCHASE_ORDER_LINE_TAB/logs/${removeDir}
...
#bash /nas/share05/tools/ExtractTools/scripts/replaceDump.sh PURCHASE_ORDER_LINE_TAB ${yest} ${yest}
bash /nas/share05/tools/ExtractTools/PURCHASE_ORDER_LINE_TAB/driver.sh /nas/share05/tools/ExtractTools/PURCHASE_ORDER_LINE_TAB /nas/share05/tools/ExtractTools/PURCHASE_ORDER_LINE_TAB/tmp $yest 
retVal=$?
if [ $retVal -eq 0 ];
then
#mv /mnt/beegfs_bsl/tools/ExtractTools/PURCHASE_ORDER_LINE_TAB/tmp/$yest /mnt/beegfs_bsl/live/DB_extract_lz/PURCHASE_ORDER_LINE_TAB/incoming
retVal=$?
if [ $retVal -eq 0 ];
then
