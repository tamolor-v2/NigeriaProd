...
rm -r /nas/share05/tools/ExtractTools/LEDGER_ITEM/logs/${removeDir}
...
bash /nas/share05/tools/ExtractTools/LEDGER_ITEM/driver.sh /nas/share05/tools/ExtractTools/LEDGER_ITEM /nas/share05/tools/ExtractTools/LEDGER_ITEM/tmp/Omar $yest 
retVal=$?
if [ $retVal -eq 0 ];
then
mv /nas/share05/tools/ExtractTools/LEDGER_ITEM/tmp/$yest /mnt/beegfs_bsl/live/DB_extract_lz/LEDGER_ITEM/incoming
retVal=$?
if [ $retVal -eq 0 ];
then
