...
rm -r /nas/share05/tools/ExtractTools/HISTORY_LOG/logs/${removeDir}
...
bash /nas/share05/tools/ExtractTools/scripts/replaceDump.sh HISTORY_LOG ${yest}  


bash /nas/share05/tools/ExtractTools/HISTORY_LOG/driver.sh /nas/share05/tools/ExtractTools/HISTORY_LOG /nas/share05/tools/ExtractTools/HISTORY_LOG/tmp $yest 
retVal=$?
if [ $retVal -eq 0 ];
then
mv /nas/share05/tools/ExtractTools/HISTORY_LOG/tmp/$yest /mnt/beegfs_bsl/live/DB_extract_lz/HISTORY_LOG/incoming
retVal=$?
if [ $retVal -eq 0 ];
then
