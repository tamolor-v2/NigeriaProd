...
rm -r /nas/share05/tools/ExtractTools/DEALER_TYPE/logs/${removeDir}
...
bash /nas/share05/tools/ExtractTools/scripts/replaceDump.sh DEALER_TYPE ${yest}  


bash /nas/share05/tools/ExtractTools/DEALER_TYPE/driver.sh /nas/share05/tools/ExtractTools/DEALER_TYPE /nas/share05/tools/ExtractTools/DEALER_TYPE/tmp $yest 
retVal=$?
if [ $retVal -eq 0 ];
then
mv /nas/share05/tools/ExtractTools/DEALER_TYPE/tmp/$yest /mnt/beegfs_bsl/live/DB_extract_lz/DEALER_TYPE/incoming
retVal=$?
if [ $retVal -eq 0 ];
then
