...
rm -r /nas/share05/tools/ExtractTools/INVOICE/logs/${removeDir}
...
bash /nas/share05/tools/ExtractTools/INVOICE/driver.sh /nas/share05/tools/ExtractTools/INVOICE /nas/share05/tools/ExtractTools/INVOICE/tmp/Omar $yest 
retVal=$?
if [ $retVal -eq 0 ];
then
mv /nas/share05/tools/ExtractTools/INVOICE/tmp/$yest /mnt/beegfs_bsl/live/DB_extract_lz/INVOICE/incoming
retVal=$?
if [ $retVal -eq 0 ];
then
