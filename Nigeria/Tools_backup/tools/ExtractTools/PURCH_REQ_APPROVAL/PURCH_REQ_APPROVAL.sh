...
rm -r /nas/share05/tools/ExtractTools/PURCH_REQ_APPROVAL/logs/${removeDir}
...
bash /nas/share05/tools/ExtractTools/scripts/replaceDump.sh PURCH_REQ_APPROVAL ${yest}  


bash /nas/share05/tools/ExtractTools/PURCH_REQ_APPROVAL/driver.sh /nas/share05/tools/ExtractTools/PURCH_REQ_APPROVAL /nas/share05/tools/ExtractTools/PURCH_REQ_APPROVAL/tmp $yest 
retVal=$?
if [ $retVal -eq 0 ];
then
mv /nas/share05/tools/ExtractTools/PURCH_REQ_APPROVAL/tmp/$yest /mnt/beegfs_bsl/live/DB_extract_lz/PURCH_REQ_APPROVAL/incoming
retVal=$?
if [ $retVal -eq 0 ];
then
