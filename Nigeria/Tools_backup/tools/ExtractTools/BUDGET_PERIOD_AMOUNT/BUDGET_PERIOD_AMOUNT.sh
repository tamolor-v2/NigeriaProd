...
rm -r /nas/share05/tools/ExtractTools/CB_RETAIL_OUTLETS/logs/${removeDir}
...
bash /nas/share05/tools/ExtractTools/scripts/replaceDump.sh BUDGET_PERIOD_AMOUNT ${yest} ${yest}

bash /nas/share05/tools/ExtractTools/BUDGET_PERIOD_AMOUNT/driver.sh /nas/share05/tools/ExtractTools/BUDGET_PERIOD_AMOUNT /nas/share05/tools/ExtractTools/BUDGET_PERIOD_AMOUNT/tmp $yest 
retVal=$?
if [ $retVal -eq 0 ];
then
mv /nas/share05/tools/ExtractTools/BUDGET_PERIOD_AMOUNT/tmp/$yest /mnt/beegfs_bsl/live/DB_extract_lz/BUDGET_PERIOD_AMOUNT/incoming
retVal=$?
if [ $retVal -eq 0 ];
then
