...
#                echo "work on anum: ${anum}"
                ...
                kv="\${DATE}=${DATE}"
                file_name="${DATE}_MKT_DATA_METRICS.gz"
                log_file=${DATE}_MKT_DATA_METRICS.log
...
#                file_name=".${DATE}MKT_DATA_METRICS_${hour}_30_0${anum}.gz"
#                log_file=${DATE}MKT_DATA_METRICS_${hour}_30_0${anum}.log
