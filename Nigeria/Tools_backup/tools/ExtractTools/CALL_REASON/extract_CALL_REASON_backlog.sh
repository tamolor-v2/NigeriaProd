...
yest=$2
dday=$(echo $2|cut -c7-8)
echo "\n Using date=$yest dday=$dday \n"
...
echo "msisdn = $1"
bash /nas/share05/tools/ExtractTools/CALL_REASON/driver_CALL_REASON_backlog.sh /nas/share05/tools/ExtractTools/CALL_REASON /nas/share05/tools/ExtractTools/CALL_REASON/tmp_backlog/ $yest "$1" $dday
retVal=$?
if [ $retVal -eq 0 ];
then
#mv /mnt/beegfs_bsl/FlareData/CDR/CALL_REASON/tmp_backlog/$yest /mnt/beegfs_bsl/live/DB_extract_lz/CALL_REASON/incoming/
