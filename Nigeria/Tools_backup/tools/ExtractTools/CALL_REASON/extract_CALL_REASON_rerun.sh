...
echo "msisdn = $1"
bash /nas/share05/tools/ExtractTools/CALL_REASON/driver_CALL_REASON.sh /mnt/beegfs_bsl/tools/ExtractTools/CALL_REASON /mnt/beegfs_bsl/FlareData/CDR/CALL_REASON/tmp/ $yest "$1"
retVal=$?
if [ $retVal -eq 0 ];
then
