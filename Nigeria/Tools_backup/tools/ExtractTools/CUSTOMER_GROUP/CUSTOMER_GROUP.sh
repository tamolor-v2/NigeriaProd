...
rm -r /nas/share05/tools/ExtractTools/CUSTOMER_GROUP/logs/${removeDir}
...
bash /nas/share05/tools/ExtractTools/scripts/replaceDump.sh CUSTOMER_GROUP ${yest} ${yest}
bash /nas/share05/tools/ExtractTools/CUSTOMER_GROUP/driver.sh /nas/share05/tools/ExtractTools/CUSTOMER_GROUP /nas/share05/tools/ExtractTools/CUSTOMER_GROUP/tmp $yest 
retVal=$?
if [ $retVal -eq 0 ];
then
mv /nas/share05/tools/ExtractTools/CUSTOMER_GROUP/tmp/$yest /mnt/beegfs_bsl/live/DB_extract_lz/CUSTOMER_GROUP/incoming
retVal=$?
if [ $retVal -eq 0 ];
then
