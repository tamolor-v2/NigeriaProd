...
rm -r /nas/share05/tools/ExtractTools/SALES_PRICE_LIST_PART/logs/${removeDir}
...
bash /nas/share05/tools/ExtractTools/scripts/replaceDump.sh SALES_PRICE_LIST_PART ${yest} ${yest}
bash /nas/share05/tools/ExtractTools/SALES_PRICE_LIST_PART/driver.sh /nas/share05/tools/ExtractTools/SALES_PRICE_LIST_PART /nas/share05/tools/ExtractTools/SALES_PRICE_LIST_PART/tmp $yest 
retVal=$?
if [ $retVal -eq 0 ];
then
mv /nas/share05/tools/ExtractTools/SALES_PRICE_LIST_PART/tmp/$yest /mnt/beegfs_bsl/live/DB_extract_lz/SALES_PRICE_LIST_PART/incoming
retVal=$?
if [ $retVal -eq 0 ];
then
