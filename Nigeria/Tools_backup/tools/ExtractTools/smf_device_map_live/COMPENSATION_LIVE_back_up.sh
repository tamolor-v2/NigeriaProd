...
echo "move files..."
rmdir /mnt/beegfs/FlareDataTest/COMPENSATION/incoming/$yest
mv /mnt/beegfs/tools/ExtractTools/COMPENSATION/tmp/$yest /mnt/beegfs/FlareDataTest/COMPENSATION/incoming/
