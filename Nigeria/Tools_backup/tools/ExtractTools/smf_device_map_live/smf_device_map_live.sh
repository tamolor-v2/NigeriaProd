...
#rm -r /mnt/beegfs_bsl/tools/ExtractTools/COMPENSATION/logs/${removeDir}
...
bash /mnt/beegfs_bsl/tools/ExtractTools/smf_device_map_live/driver.sh /mnt/beegfs_bsl/tools/ExtractTools/smf_device_map_live /mnt/beegfs_bsl/tools/ExtractTools/smf_device_map_live/tmp $yest 
retVal=$?
if [ $retVal -eq 0 ];
then
mv /mnt/beegfs_bsl/tools/ExtractTools/smf_device_map_live/tmp/$yest /mnt/beegfs_bsl/live/DB_extract_lz/smf_device_map_live/incoming
retVal=$?
if [ $retVal -eq 0 ];
then
