...
rm -r /nas/share05/tools/ExtractTools/CUSTOMER_CREDIT_INFO/logs/${removeDir}
...
bash /nas/share05/tools/ExtractTools/scripts/replaceDump.sh CUSTOMER_CREDIT_INFO ${yest} ${yest}
bash /nas/share05/tools/ExtractTools/CUSTOMER_CREDIT_INFO/driver.sh /nas/share05/tools/ExtractTools/CUSTOMER_CREDIT_INFO /nas/share05/tools/ExtractTools/CUSTOMER_CREDIT_INFO/tmp $yest 
retVal=$?
if [ $retVal -eq 0 ];
then
mv /nas/share05/tools/ExtractTools/CUSTOMER_CREDIT_INFO/tmp/$yest /mnt/beegfs_bsl/live/DB_extract_lz/CUSTOMER_CREDIT_INFO/incoming
retVal=$?
if [ $retVal -eq 0 ];
then
