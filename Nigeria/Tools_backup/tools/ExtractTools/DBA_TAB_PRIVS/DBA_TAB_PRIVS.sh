...
bash /nas/share05/tools/ExtractTools/scripts/replaceDump.sh DBA_TAB_PRIVS ${yest}  


bash /nas/share05/tools/ExtractTools/DBA_TAB_PRIVS/driver.sh /nas/share05/tools/ExtractTools/DBA_TAB_PRIVS /nas/share05/tools/ExtractTools/DBA_TAB_PRIVS/tmp $yest 
retVal=$?
if [ $retVal -eq 0 ];
then
mv /nas/share05/tools/ExtractTools/DBA_TAB_PRIVS/tmp/$yest /mnt/beegfs_bsl/live/DB_extract_lz/DBA_TAB_PRIVS/incoming
retVal=$?
if [ $retVal -eq 0 ];
then
