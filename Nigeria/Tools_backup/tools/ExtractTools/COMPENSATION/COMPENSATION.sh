...
bash /nas/share05/tools/ExtractTools/COMPENSATION/driver.sh /mnt/beegfs_bsl/tools/ExtractTools/COMPENSATION /mnt/beegfs_bsl/tools/ExtractTools/COMPENSATION/tmp $yest 
retVal=$?
if [ $retVal -eq 0 ];
then
print "hello"
mv /mnt/beegfs_bsl/tools/ExtractTools/COMPENSATION/tmp/$yest /mnt/beegfs_bsl/live/DB_extract_lz/COMPENSATION/incoming
retVal=$?
if [ $retVal -eq 0 ];
then
