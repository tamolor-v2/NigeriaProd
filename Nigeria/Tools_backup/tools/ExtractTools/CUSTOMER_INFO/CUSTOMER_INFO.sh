...
rm -r /mnt/beegfs_bsl/tools/ExtractTools/CUSTOMER_INFO/logs/${removeDir}
...
#bash /nas/share05/tools/ExtractTools/scripts/replaceDump.sh CUSTOMER_INFO ${yest} ${yest}
bash /nas/share05/tools/ExtractTools/CUSTOMER_INFO/driver.sh /nas/share05/tools/ExtractTools/CUSTOMER_INFO /nas/share05/tools/ExtractTools/CUSTOMER_INFO/tmp $yest 
retVal=$?
if [ $retVal -eq 0 ];
then
#mv /mnt/beegfs_bsl/tools/ExtractTools/CUSTOMER_INFO/tmp/$yest /mnt/beegfs_bsl/live/DB_extract_lz/CUSTOMER_INFO/incoming
retVal=$?
if [ $retVal -eq 0 ];
then
