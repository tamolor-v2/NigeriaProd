...
#                kv="\${date}=${DATE};\${hour}=${hour};\${minS}=00;\${minE}=29;\${anum}=${anum}"
                file_name=".${DATE}_WSQ_IMAGE_${msisdn}.gz"
                log_file=${DATE}_${msisdn}_WSQ_IMAGE.log
#					 kv="\${DATE}=${DATE}"
...
#                file_name=".${DATE}_WSQ_IMAGE_${hour}_30_0${anum}.gz"
#                log_file=${DATE}_WSQ_IMAGE_${hour}_30_0${anum}.log
