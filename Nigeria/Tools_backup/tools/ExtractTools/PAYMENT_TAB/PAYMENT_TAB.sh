...
rm -r /nas/share05/tools/ExtractTools/PAYMENT_TAB/logs/${removeDir}
...
bash /nas/share05/tools/ExtractTools/scripts/replaceDump.sh PAYMENT_TAB ${yest}  


bash /nas/share05/tools/ExtractTools/PAYMENT_TAB/driver.sh /nas/share05/tools/ExtractTools/PAYMENT_TAB /nas/share05/tools/ExtractTools/PAYMENT_TAB/tmp $yest 
retVal=$?
if [ $retVal -eq 0 ];
then
mv /nas/share05/tools/ExtractTools/PAYMENT_TAB/tmp/$yest /mnt/beegfs_bsl/live/DB_extract_lz/PAYMENT_TAB/incoming
retVal=$?
if [ $retVal -eq 0 ];
then
