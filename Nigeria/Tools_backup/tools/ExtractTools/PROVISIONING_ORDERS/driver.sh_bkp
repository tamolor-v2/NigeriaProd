...
#                kv="\${date}=${DATE};\${hour}=${hour};\${minS}=00;\${minE}=29;\${anum}=${anum}"
                file_name=".${DATE}_AYA_PROVISIONING_ORDERS.gz"
                log_file=${DATE}_AYA_PROVISIONING_ORDERS.log
                kv="\${DATE}=${DATE}"
...
#                file_name=".${DATE}_PROVISIONING_ORDERS_${hour}_30_0${anum}.gz"
#                log_file=${DATE}_PROVISIONING_ORDERS_${hour}_30_0${anum}.log
