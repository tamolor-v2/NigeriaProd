...
cd ${WORK_DIR}
        for msisdn in "${MSISDN_FILTER[@]}"; do
                ...
                command="bash /home/daasuser/JDBC_Tool/JDBCExtract.scala --configFile ${WORK_DIR}/CB_SERV_MAST_VIEW_config.properties --sqlFile ${WORK_DIR}/CB_SERV_MAST_VIEW_query_template.sql --outputFile ${output_dir}/${file_name} --delimiter ${DELIMITER} --kvTemplate ${kv}"
