...
bash /mnt/beegfs_bsl/tools/ExtractTools/CB_SERV_MAST_VIEW/driver_CB_SERV_MAST_VIEW.sh /mnt/beegfs_bsl/tools/ExtractTools/CB_SERV_MAST_VIEW/ /mnt/beegfs_bsl/FlareData/CDR/CB_SERV_MAST_VIEW/tmp $yest " 1 2 3 7 8 9 "
retVal=$?
if [ $retVal -eq 0 ];
then
