...
rm -r /mnt/beegfs_bsl/tools/ExtractTools/CB_POS_TRANSACTIONS/logs/${removeDir}
...
bash /nas/share05/tools/ExtractTools/CB_POS_TRANSACTIONS/driver.sh /mnt/beegfs_bsl/tools/ExtractTools/CB_POS_TRANSACTIONS /mnt/beegfs_bsl/tools/ExtractTools/CB_POS_TRANSACTIONS/tmp
retVal=$?
if [ $retVal -eq 0 ];
then
mv /mnt/beegfs_bsl/tools/ExtractTools/CB_POS_TRANSACTIONS/tmp/$yest /mnt/beegfs_bsl/live/DB_extract_lz/CB_POS_TRANSACTIONS/incoming
retVal=$?
if [ $retVal -eq 0 ];
then
