...
rm -r /nas/share05/tools/ExtractTools/TAX_ITEM_QRY/logs/${removeDir}
...
bash /nas/share05/tools/ExtractTools/scripts/replaceDump.sh TAX_ITEM_QRY ${yest}
...
bash /nas/share05/tools/ExtractTools/TAX_ITEM_QRY/driver.sh /nas/share05/tools/ExtractTools/TAX_ITEM_QRY /nas/share05/tools/ExtractTools/TAX_ITEM_QRY/tmp $yest 
retVal=$?
if [ $retVal -eq 0 ];
then
mv /nas/share05/tools/ExtractTools/TAX_ITEM_QRY/tmp/$yest /mnt/beegfs_bsl/live/DB_extract_lz/TAX_ITEM_QRY/incoming
retVal=$?
if [ $retVal -eq 0 ];
then
