...
bash /mnt/beegfs_bsl/tools/ExtractTools/DASHBOARD_QUARANTINE/driver.sh /mnt/beegfs_bsl/tools/ExtractTools/DASHBOARD_QUARANTINE /mnt/beegfs_bsl/tools/ExtractTools/DASHBOARD_QUARANTINE/tmp/Aya $yest 
retVal=$?
if [ $retVal -eq 0 ];
then
mv /mnt/beegfs_bsl/tools/ExtractTools/DASHBOARD_QUARANTINE/tmp/$yest /mnt/beegfs_bsl/live/DB_extract_lz/DASHBOARD_QUARANTINE/incoming
retVal=$?
if [ $retVal -eq 0 ];
then
