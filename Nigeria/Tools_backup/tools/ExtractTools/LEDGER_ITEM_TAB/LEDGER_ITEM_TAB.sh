...
rm -r /nas/share05/tools/ExtractTools/LEDGER_ITEM_TAB/logs/${removeDir}
...
bash /nas/share05/tools/ExtractTools/scripts/replaceDump.sh LEDGER_ITEM_TAB ${yest}  


bash /nas/share05/tools/ExtractTools/LEDGER_ITEM_TAB/driver.sh /nas/share05/tools/ExtractTools/LEDGER_ITEM_TAB /nas/share05/tools/ExtractTools/LEDGER_ITEM_TAB/tmp $yest 
retVal=$?
if [ $retVal -eq 0 ];
then
mv /nas/share05/tools/ExtractTools/LEDGER_ITEM_TAB/tmp/$yest /mnt/beegfs_bsl/live/DB_extract_lz/LEDGER_ITEM_TAB/incoming
retVal=$?
if [ $retVal -eq 0 ];
then
