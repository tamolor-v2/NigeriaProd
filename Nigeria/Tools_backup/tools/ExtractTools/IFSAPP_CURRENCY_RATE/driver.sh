...
kv="\${DATE}=${DATE};"
file_name="${DATE}_IFSAPP_CURRENCY_RATE.gz"
log_file=${DATE}_IFSAPP_CURRENCY_RATE.log
...
#     echo "starting command: ${command}"
#     nohup  ${command} >  ${log_dir}/${log_file}  2>&1 &
#     # mv ${output_dir} /mnt/beegfs_bsl/live/DB_extract_lz/IFSAPP_CURRENCY_RATE/incoming/
#     ((day++))
