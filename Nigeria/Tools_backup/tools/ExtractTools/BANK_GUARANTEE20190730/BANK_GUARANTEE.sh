...
bash /mnt/beegfs_bsl/tools/ExtractTools/BANK_GUARANTEE/driver.sh /mnt/beegfs_bsl/tools/ExtractTools/BANK_GUARANTEE /mnt/beegfs_bsl/tools/ExtractTools/BANK_GUARANTEE/tmp/Omar $yest 
retVal=$?
if [ $retVal -eq 0 ];
then
#mv /mnt/beegfs_bsl/tools/ExtractTools/BANK_GUARANTEE/tmp/$yest /mnt/beegfs_bsl/live/DB_extract_lz/BANK_GUARANTEE/incoming
retVal=$?
if [ $retVal -eq 0 ];
then
