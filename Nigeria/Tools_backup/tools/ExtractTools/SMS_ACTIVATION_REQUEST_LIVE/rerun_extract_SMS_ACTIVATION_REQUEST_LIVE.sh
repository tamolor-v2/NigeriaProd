...
bash /nas/share05/tools/ExtractTools/SMS_ACTIVATION_REQUEST_LIVE/SMS_ACTIVATION_REQUEST_LIVE.sh ${currDate}
retVal=$?
echo "ret2=$retVal"
if [ $retVal -eq 0 ];
then
...
hadoop fs -put /nas/share05/tools/ExtractTools/SMS_ACTIVATION_REQUEST_LIVE/spool/SMS_ACTIVATION_REQUEST_LIVE_${currDate}.csv.gz /FlareData/output_8/SMS_ACTIVATION_REQUEST_LIVE/tbl_dt=${currDate}/
