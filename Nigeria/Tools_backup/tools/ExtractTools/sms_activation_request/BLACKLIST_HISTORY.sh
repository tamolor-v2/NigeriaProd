...
bash /mnt/beegfs/tools/ExtractTools/BLACKLIST_HISTORY/driver.sh /mnt/beegfs/tools/ExtractTools/BLACKLIST_HISTORY /mnt/beegfs/tools/ExtractTools/BLACKLIST_HISTORY/tmp/Aya $yest 
retVal=$?
if [ $retVal -eq 0 ];
then
