...
bash /mnt/beegfs_bsl/tools/ExtractTools/CB_ACCOUNT_MASTER/driver_CB_ACCOUNT_MASTER.sh /mnt/beegfs_bsl/tools/ExtractTools/CB_ACCOUNT_MASTER/ /mnt/beegfs_bsl/FlareData/CDR/CB_ACCOUNT_MASTER/tmp $yest "0"
retVal=$?
if [ $retVal -eq 0 ];
then
...
mv /mnt/beegfs_bsl/FlareData/CDR/CB_ACCOUNT_MASTER/tmp/$yest/* /mnt/beegfs_bsl/FlareData/CDR/CB_ACCOUNT_MASTER/incoming/
