...
rm -r /nas/share05/tools/ExtractTools/CUSTOMER_DETAILS/logs/${removeDir}
...
bash /nas/share05/tools/ExtractTools/scripts/replaceDump.sh CUSTOMER_DETAILS ${yest}  


bash /nas/share05/tools/ExtractTools/CUSTOMER_DETAILS/driver.sh /nas/share05/tools/ExtractTools/CUSTOMER_DETAILS /nas/share05/tools/ExtractTools/CUSTOMER_DETAILS/tmp $yest 
retVal=$?
if [ $retVal -eq 0 ];
then
mv /nas/share05/tools/ExtractTools/CUSTOMER_DETAILS/tmp/$yest /mnt/beegfs_bsl/live/DB_extract_lz/CUSTOMER_DETAILS/incoming
retVal=$?
if [ $retVal -eq 0 ];
then
