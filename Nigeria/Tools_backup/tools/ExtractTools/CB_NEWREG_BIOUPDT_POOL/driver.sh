...
#                kv="\${date}=${DATE};\${hour}=${hour};\${minS}=00;\${minE}=29;\${anum}=${anum}"
                file_name=".${DATE}_CB_NEWREG_BIOUPDT_POOL_${msisdn}.gz"
                log_file=${DATE}_${msisdn}_CB_NEWREG_BIOUPDT_POOL.log
#					 kv="\${DATE}=${DATE}"
...
#                file_name=".${DATE}_CB_NEWREG_BIOUPDT_POOL_${hour}_30_0${anum}.gz"
#                log_file=${DATE}_CB_NEWREG_BIOUPDT_POOL_${hour}_30_0${anum}.log
