...
#                kv="\${date}=${DATE};\${hour}=${hour};\${minS}=00;\${minE}=29;\${anum}=${anum}"
                 file_name=".${DATE}_tbl_imei_registration_dtls_vw.gz"
               # file_name=".${history_date}_tbl_imei_registration_dtls_vw"
                log_file=${DATE}_tbl_imei_registration_dtls_vw.log
...
#                file_name=".${DATE}_MASTER_DATA_VIEW_${hour}_30_0${anum}.gz"
#                log_file=${DATE}_MASTER_DATA_VIEW_${hour}_30_0${anum}.log
