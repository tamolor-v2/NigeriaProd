...
then
yest=$(date -d '-1 day' '+%Y%m%d')
hdfs dfs -rm /FlareDate/output_8/RETAIL_SHOP/tbl_dt=$yest/*
rmdir /mnt/beegfs_bsl/live/DB_extract_lz/RETAIL_SHOP/incoming/$yest
rmdir /mnt/beegfs_bsl/FlareData/CDR/RETAIL_SHOP/$yest
mv /nas/share05/tools/ExtractTools/RETAIL_SHOP/tmp/$yest /mnt/beegfs_bsl/live/DB_extract_lz/RETAIL_SHOP/incoming
retVal=$?
if [ $retVal -eq 0 ];
then
