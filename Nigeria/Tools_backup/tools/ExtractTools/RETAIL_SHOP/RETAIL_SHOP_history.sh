...
#bash /nas/share05/tools/ExtractTools/scripts/replaceDump.sh RETAIL_SHOP ${yest} ${yest}

bash /nas/share05/tools/ExtractTools/RETAIL_SHOP/driver.sh /nas/share05/tools/ExtractTools/RETAIL_SHOP /nas/share05/tools/ExtractTools/RETAIL_SHOP/tmp $yest 
retVal=$?
if [ $retVal -eq 0 ];
then
yest=$(date -d '-1 day' '+%Y%m%d')
hdfs dfs -rm /user/mtn_user/kamanja_test/RETAIL_SHOP/tbl_dt=$yest/*
rmdir /mnt/beegfs_bsl/live/DB_extract_lz/RETAIL_SHOP/incoming/$yest
rmdir /mnt/beegfs_bsl/FlareData/CDR/RETAIL_SHOP/$yest
mv /mnt/beegfs_bsl/tools/ExtractTools/RETAIL_SHOP/tmp/$yest /mnt/beegfs_bsl/live/DB_extract_lz/RETAIL_SHOP/incoming
retVal=$?
if [ $retVal -eq 0 ];
then
