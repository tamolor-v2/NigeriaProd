...
rm -r /nas/share05/tools/ExtractTools/CORPORATE_FORM/logs/${removeDir}
...
bash /nas/share05/tools/ExtractTools/scripts/replaceDump.sh CORPORATE_FORM ${yest} ${yest}
bash /nas/share05/tools/ExtractTools/CORPORATE_FORM/driver.sh /nas/share05/tools/ExtractTools/CORPORATE_FORM /nas/share05/tools/ExtractTools/CORPORATE_FORM/tmp $yest 
retVal=$?
if [ $retVal -eq 0 ];
then
mv /nas/share05/tools/ExtractTools/CORPORATE_FORM/tmp/$yest /mnt/beegfs_bsl/live/DB_extract_lz/CORPORATE_FORM/incoming
retVal=$?
if [ $retVal -eq 0 ];
then
