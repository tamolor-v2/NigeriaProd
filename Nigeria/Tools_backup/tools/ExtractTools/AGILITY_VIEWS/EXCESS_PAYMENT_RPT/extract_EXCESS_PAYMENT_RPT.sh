...
hostName=$(hostname)
##bash /mnt/beegfs_bsl/tools/JsonBuilder/JsonBuilder.scala --id 12 --status 0 --hostname "$hostName" --step 1 --log_directory "/nas/share05/tools/ExtractTools/EXCESS_PAYMENT_RPT/logs/$yest/" --brokers $kafkaHostList --topic $TopicName
### push to kafka here
...
bash /nas/share05/tools/ExtractTools/AGILITY_VIEWS/EXCESS_PAYMENT_RPT/driver_EXCESS_PAYMENT_RPT.sh /nas/share05/tools/ExtractTools/AGILITY_VIEWS/EXCESS_PAYMENT_RPT /mnt/beegfs_bsl/FlareData/CDR/EXCESS_PAYMENT_RPT/tmp/ $yest 
retVal=$?
if [ $retVal -eq 0 ];
then
rmdir /mnt/beegfs_bsl/FlareData/CDR/EXCESS_PAYMENT_RPT/incoming/$yest
### mv /mnt/beegfs_bsl/FlareData/CDR/EXCESS_PAYMENT_RPT/tmp/$yest /mnt/beegfs_bsl/live/DB_extract_lz/EXCESS_PAYMENT_RPT/incoming
...
## bash /mnt/beegfs_bsl/tools/JsonBuilder/JsonBuilder.scala --id 12 --status 1 --hostname "$hostName" --step 1 --log_directory "/nas/share05/tools/ExtractTools/EXCESS_PAYMENT_RPT/logs/$yest/" --general_message "$extractedRecordsNo extracted records" --brokers $kafkaHostList --topic $TopicName
### push to kafka here
else
...
##bash /mnt/beegfs_bsl/tools/JsonBuilder/JsonBuilder.scala --id 12 --status -1 --hostname "$hostName" --step 1 --log_directory "/nas/share05/tools/ExtractTools/EXCESS_PAYMENT_RPT/logs/$yest/" --brokers $kafkaHostList --topic $TopicName
### push to kafka here
fi
