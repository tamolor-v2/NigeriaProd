...
rm -r /nas/share05/tools/ExtractTools/PURCHASE_ORDER_HIST/logs/${removeDir}
...
bash /nas/share05/tools/ExtractTools/scripts/replaceDump.sh PURCHASE_ORDER_HIST ${yest}  


bash /nas/share05/tools/ExtractTools/PURCHASE_ORDER_HIST/driver.sh /nas/share05/tools/ExtractTools/PURCHASE_ORDER_HIST /nas/share05/tools/ExtractTools/PURCHASE_ORDER_HIST/tmp $yest 
retVal=$?
if [ $retVal -eq 0 ];
then
mv /nas/share05/tools/ExtractTools/PURCHASE_ORDER_HIST/tmp/$yest /mnt/beegfs_bsl/live/DB_extract_lz/PURCHASE_ORDER_HIST/incoming
retVal=$?
if [ $retVal -eq 0 ];
then
