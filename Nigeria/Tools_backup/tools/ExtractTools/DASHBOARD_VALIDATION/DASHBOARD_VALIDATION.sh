...
rm -r /mnt/beegfs_bsl/tools/ExtractTools/DASHBOARD_VALIDATION/logs/${removeDir}
...
bash /mnt/beegfs_bsl/tools/ExtractTools/DASHBOARD_VALIDATION/driver.sh /mnt/beegfs_bsl/tools/ExtractTools/DASHBOARD_VALIDATION /mnt/beegfs_bsl/tools/ExtractTools/DASHBOARD_VALIDATION/tmp/Aya $yest 
retVal=$?
if [ $retVal -eq 0 ];
then
mv /mnt/beegfs_bsl/tools/ExtractTools/DASHBOARD_VALIDATION/tmp/$yest /mnt/beegfs_bsl/live/DB_extract_lz/DASHBOARD_VALIDATION/incoming
retVal=$?
if [ $retVal -eq 0 ];
then
