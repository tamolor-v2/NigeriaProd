...
rm -r /mnt/beegfs/tools/ExtractTools/LEDGER_ITEM_TAB/logs/${removeDir}
...
bash /mnt/beegfs/tools/ExtractTools/LEDGER_ITEM_TAB/driver.sh /mnt/beegfs/tools/ExtractTools/LEDGER_ITEM_TAB /mnt/beegfs/tools/ExtractTools/LEDGER_ITEM_TAB/tmp/Aya $yest 
retVal=$?
if [ $retVal -eq 0 ];
then
