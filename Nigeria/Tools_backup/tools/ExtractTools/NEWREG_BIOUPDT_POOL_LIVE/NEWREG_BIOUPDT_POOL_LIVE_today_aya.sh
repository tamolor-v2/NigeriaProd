...
filename="NEWREG_BIOUPDT_POOL_LIVE_JAN_"$yyyymmdd".csv" #maxSeq=$(</mnt/beegfs_bsl/tools/ExtractTools/NEWREG_BIOUPDT_POOL_LIVE/staging/maxSeq.txt)N
...
where  SEQ_NO_N> 105233570
and updated_dt>=to_date('20181130 23:59:59','yyyymmdd hh24:mi:ss');
spool off
quit
EOF
