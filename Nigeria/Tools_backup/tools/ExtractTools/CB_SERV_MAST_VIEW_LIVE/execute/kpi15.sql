start transaction;
delete from kpi.kpi_val where kpi_id='KPI-000015' and tbl_dt=20190108;
insert into kpi.kpi_val
select
cast(20190108 as int) as date_key,
cast('KPI-000015' as varchar) as kpi_name,
cast('Data Subscribers' as varchar) as kpi_desc,
...
cast(count(distinct msisdn_key) as bigint) as kpi000015,
