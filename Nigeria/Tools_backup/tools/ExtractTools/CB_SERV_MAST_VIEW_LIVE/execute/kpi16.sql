start transaction;
delete from kpi.kpi_val where kpi_id='KPI-000016' and tbl_dt=20190108;
insert into kpi.kpi_val
select
cast(20190108 as int) as date_key,
cast('KPI-000016' as varchar) as kpi_name,
cast('Data Subscribers as a % Total Subscribers' as varchar) as kpi_desc,
...
cast(round(100*(data_subs/closing_base),4) as double) as kpi000016,
