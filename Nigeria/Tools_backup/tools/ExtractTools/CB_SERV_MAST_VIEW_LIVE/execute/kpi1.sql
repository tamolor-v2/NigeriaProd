start transaction;
delete from kpi.kpi_val where kpi_id='KPI-000001' and tbl_dt=20190108;
insert into kpi.kpi_val
select
cast(20190108 as int) as date_key,
cast('KPI-000001' as varchar) as kpi_name,
cast('RGS 30' as varchar) as kpi_desc,
cast(count(distinct msisdn_key) as bigint) as kpi000001,
...
cast(20190108 as int) as date_key
from 
flare_8.customersubject where tbl_dt=20190108 and aggr='daily' 
and dola between 0 and 29 and (is_in_today_sdp or is_in_prevdays_sdp) and msisdn_key>0;
commit;
