start transaction;
delete from kpi.kpi_val where kpi_id='KPI-000023' and tbl_dt=20190108;
insert into kpi.kpi_val
select
cast(20190108 as int) as date_key,
cast('KPI-000023' as varchar) as kpi_name,
cast('% of device of total that are smartphone' as varchar) as kpi_desc,
...
cast(round(100.0*(device_smart_devicecount/tot_uniq_devicecount),2) as double) as kpi000023,
...
from (
select
cast(count(distinct case when a.smartphone_ind=1 then imei else '0' end)*1.0 as double)-1 device_smart_devicecount,
