start transaction;
delete from kpi.kpi_val where kpi_id='KPI-000020' and tbl_dt=20190108;
insert into kpi.kpi_val
select
cast(20190108 as int) as date_key,
cast('KPI-000020' as varchar) as kpi_name,
cast('SMS Subscribers' as varchar) as kpi_desc,
...
cast(count(distinct msisdn_key) as bigint) as kpi000020,
