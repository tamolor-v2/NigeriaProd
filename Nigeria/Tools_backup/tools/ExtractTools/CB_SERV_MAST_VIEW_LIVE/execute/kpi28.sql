start transaction;
delete from kpi.kpi_val where kpi_id='KPI-000028' and tbl_dt=20190108;
insert into kpi.kpi_val
select
cast(20190108 as int) as date_key,
cast('KPI-000028' as varchar) as kpi_name,
cast('Number of Enterprise subscribers' as varchar) as kpi_desc,
...
cast(count(distinct a.msisdn_key) as bigint) as kpi000028,
