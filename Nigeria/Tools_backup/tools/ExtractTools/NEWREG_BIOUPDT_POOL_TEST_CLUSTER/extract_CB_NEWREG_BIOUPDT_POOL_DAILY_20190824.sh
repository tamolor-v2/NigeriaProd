...
bash /nas/share05/tools/ExtractTools/CB_NEWREG_BIOUPDT_POOL_DAILY/driver_CB_NEWREG_BIOUPDT_POOL_DAILY.sh /mnt/beegfs_bsl/tools/ExtractTools/CB_NEWREG_BIOUPDT_POOL_DAILY /mnt/beegfs_bsl/FlareData/CDR/NEWREG_BIOUPDT_POOL_DAILY/tmp/ $yest 
retVal=$?
if [ $retVal -eq 0 ];
then
rmdir /mnt/beegfs_bsl/FlareData/CDR/NEWREG_BIOUPDT_POOL_DAILY/incoming/$yest
 mv /mnt/beegfs_bsl/FlareData/CDR/NEWREG_BIOUPDT_POOL_DAILY/tmp/$yest /mnt/beegfs_bsl/live/DB_extract_lz/NEWREG_BIOUPDT_POOL_DAILY/incoming
