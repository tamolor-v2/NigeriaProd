...
#                echo "work on anum: ${anum}"
                ...
                kv="\${DATE}=${DATE}"
                file_name="${DATE}_AGL_EXCESS_PAYMENT_RPT.gz"
                log_file=${DATE}_AGL_EXCESS_PAYMENT_RPT.log
...
#                file_name=".${DATE}AGL_EXCESS_PAYMENT_RPT_${hour}_30_0${anum}.gz"
#                log_file=${DATE}AGL_EXCESS_PAYMENT_RPT_${hour}_30_0${anum}.log
