...
rm -r /nas/share05/tools/ExtractTools/CUSTOMER_INFO_TAB/logs/${removeDir}
...
bash /nas/share05/tools/ExtractTools/scripts/replaceDump.sh CUSTOMER_INFO_TAB ${yest}  


bash /nas/share05/tools/ExtractTools/CUSTOMER_INFO_TAB/driver.sh /nas/share05/tools/ExtractTools/CUSTOMER_INFO_TAB /nas/share05/tools/ExtractTools/CUSTOMER_INFO_TAB/tmp $yest 
retVal=$?
if [ $retVal -eq 0 ];
then
mv /nas/share05/tools/ExtractTools/CUSTOMER_INFO_TAB/tmp/$yest /mnt/beegfs_bsl/live/DB_extract_lz/CUSTOMER_INFO_TAB/incoming
retVal=$?
if [ $retVal -eq 0 ];
then
