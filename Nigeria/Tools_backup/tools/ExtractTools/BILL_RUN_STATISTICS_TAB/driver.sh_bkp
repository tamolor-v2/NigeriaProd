...
#                echo "work on anum: ${anum}"
                ...
                kv="\${DATE}=${DATE}"
                file_name="${DATE}_BILL_RUN_STATISTICS_TAB.gz"
                log_file=${DATE}_BILL_RUN_STATISTICS_TAB.log
...
#                file_name=".${DATE}BILL_RUN_STATISTICS_TAB_${hour}_30_0${anum}.gz"
#                log_file=${DATE}BILL_RUN_STATISTICS_TAB_${hour}_30_0${anum}.log
