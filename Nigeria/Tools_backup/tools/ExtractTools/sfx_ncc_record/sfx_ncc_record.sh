...
bash /mnt/beegfs_bsl/tools/ExtractTools/sfx_ncc_record/driver.sh /mnt/beegfs_bsl/tools/ExtractTools/sfx_ncc_record /mnt/beegfs_bsl/tools/ExtractTools/sfx_ncc_record/tmp/Aya $yest 
retVal=$?
if [ $retVal -eq 0 ];
then
mv /mnt/beegfs_bsl/tools/ExtractTools/sfx_ncc_record/tmp/$yest /mnt/beegfs_bsl/live/DB_extract_lz/sfx_ncc_record/incoming
retVal=$?
if [ $retVal -eq 0 ];
then
