...
#                kv="\${date}=${DATE};\${hour}=${hour};\${minS}=00;\${minE}=29;\${anum}=${anum}"
                file_name=".${DATE}_DYNAMIC_DATA_${msisdn}.gz"
                log_file=${DATE}_${msisdn}_DYNAMIC_DATA.log
#                kv="\${DATE}=${DATE}"
...
#                file_name=".${DATE}_DYNAMIC_DATA_${hour}_30_0${anum}.gz"
#                log_file=${DATE}_DYNAMIC_DATA_${hour}_30_0${anum}.log
