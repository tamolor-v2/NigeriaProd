...
bash /nas/share05/tools/ExtractTools/DYNAMIC_DATA/driver.sh /nas/share05/tools/ExtractTools/DYNAMIC_DATA /nas/share05/tools/ExtractTools/DYNAMIC_DATA/tmp/Omar $yest "0 1 2 3"
retVal=$?
if [ $retVal -eq 0 ];
then
#mv /mnt/beegfs_bsl/FlareData/CDR/DYNAMIC_DATA/tmp/$yest /mnt/beegfs_bsl/FlareData/CDR/DYNAMIC_DATA/incoming/
