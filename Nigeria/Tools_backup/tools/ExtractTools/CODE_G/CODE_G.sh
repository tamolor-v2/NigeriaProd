...
rm -r /nas/share05/tools/ExtractTools/CODE_G/logs/${removeDir}
...
bash /nas/share05/tools/ExtractTools/scripts/replaceDump.sh CODE_G ${yest}
...
bash /nas/share05/tools/ExtractTools/CODE_G/driver.sh /nas/share05/tools/ExtractTools/CODE_G /nas/share05/tools/ExtractTools/CODE_G/tmp/ $yest 
retVal=$?
if [ $retVal -eq 0 ];
then
mv /nas/share05/tools/ExtractTools/CODE_G/tmp/$yest /mnt/beegfs_bsl/live/DB_extract_lz/CODE_G/incoming
retVal=$?
if [ $retVal -eq 0 ];
then
