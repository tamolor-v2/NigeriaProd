...
bash /mnt/beegfs_bsl/tools/ExtractTools/kyc_blacklist/driver.sh /mnt/beegfs_bsl/tools/ExtractTools/kyc_blacklist /mnt/beegfs_bsl/tools/ExtractTools/kyc_blacklist/tmp/Aya $yest 
retVal=$?
if [ $retVal -eq 0 ];
then
mv /mnt/beegfs_bsl/tools/ExtractTools/kyc_blacklist/tmp/$yest /mnt/beegfs_bsl/live/DB_extract_lz/kyc_blacklist/incoming
retVal=$?
if [ $retVal -eq 0 ];
then
