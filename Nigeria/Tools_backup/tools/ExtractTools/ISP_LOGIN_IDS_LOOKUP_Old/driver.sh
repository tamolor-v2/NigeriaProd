...
#                kv="\${date}=${DATE};\${hour}=${hour};\${minS}=00;\${minE}=29;\${anum}=${anum}"
                file_name=".${DATE}_ISP_LOGIN_IDS_LOOKUP.gz"
                log_file=${DATE}_ISP_LOGIN_IDS_LOOKUP.log
                kv="\${DATE}=${DATE}"
...
#                file_name=".${DATE}_SPON_PROVIDER_DTLS_${hour}_30_0${anum}.gz"
#                log_file=${DATE}_SPON_PROVIDER_DTLS_${hour}_30_0${anum}.log
