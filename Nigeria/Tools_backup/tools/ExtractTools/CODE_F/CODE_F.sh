...
rm -r /nas/share05/tools/ExtractTools/CODE_F/logs/${removeDir}
...
bash /nas/share05/tools/ExtractTools/scripts/replaceDump.sh CODE_F ${yest}
...
bash /nas/share05/tools/ExtractTools/CODE_F/driver.sh /nas/share05/tools/ExtractTools/CODE_F /nas/share05/tools/ExtractTools/CODE_F/tmp/ $yest 
retVal=$?
if [ $retVal -eq 0 ];
then
mv /nas/share05/tools/ExtractTools/CODE_F/tmp/$yest /mnt/beegfs_bsl/live/DB_extract_lz/CODE_F/incoming
retVal=$?
if [ $retVal -eq 0 ];
then
