...
#                echo "work on anum: ${anum}"
                ...
                kv="\${DATE}=${DATE}"
                file_name="${DATE}_IFSAPP_MANUF_FILE_DETAIL.gz"
                log_file=${DATE}_IFSAPP_MANUF_FILE_DETAIL.log
...
#                file_name=".${DATE}IFSAPP_MANUF_FILE_DETAIL_${hour}_30_0${anum}.gz"
#                log_file=${DATE}IFSAPP_MANUF_FILE_DETAIL_${hour}_30_0${anum}.log
