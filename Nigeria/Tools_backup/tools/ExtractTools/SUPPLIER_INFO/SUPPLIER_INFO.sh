...
bash /nas/share05/tools/ExtractTools/scripts/replaceDump.sh SUPPLIER_INFO ${yest}  


bash /nas/share05/tools/ExtractTools/SUPPLIER_INFO/driver.sh /nas/share05/tools/ExtractTools/SUPPLIER_INFO /nas/share05/tools/ExtractTools/SUPPLIER_INFO/tmp $yest 
retVal=$?
if [ $retVal -eq 0 ];
then
mv /nas/share05/tools/ExtractTools/SUPPLIER_INFO/tmp/$yest /mnt/beegfs_bsl/live/DB_extract_lz/SUPPLIER_INFO/incoming
retVal=$?
if [ $retVal -eq 0 ];
then
