...
rm -r /nas/share05/tools/ExtractTools/RETURN_MATERIAL_LINE/logs/${removeDir}
...
bash /nas/share05/tools/ExtractTools/scripts/replaceDump.sh RETURN_MATERIAL_LINE ${yest} ${yest}
bash /nas/share05/tools/ExtractTools/RETURN_MATERIAL_LINE/driver.sh /nas/share05/tools/ExtractTools/RETURN_MATERIAL_LINE /nas/share05/tools/ExtractTools/RETURN_MATERIAL_LINE/tmp $yest 
retVal=$?
if [ $retVal -eq 0 ];
then
mv /nas/share05/tools/ExtractTools/RETURN_MATERIAL_LINE/tmp/$yest /mnt/beegfs_bsl/live/DB_extract_lz/RETURN_MATERIAL_LINE/incoming
retVal=$?
if [ $retVal -eq 0 ];
then
