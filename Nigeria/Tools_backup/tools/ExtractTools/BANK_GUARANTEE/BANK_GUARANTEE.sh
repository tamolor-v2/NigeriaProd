...
rm -r /nas/share05/tools/ExtractTools/BANK_GUARANTEE/logs/${removeDir}
...
bash /nas/share05/tools/ExtractTools/BANK_GUARANTEE/driver.sh /nas/share05/tools/ExtractTools/BANK_GUARANTEE /nas/share05/tools/ExtractTools/BANK_GUARANTEE/tmp/Omar $yest 
retVal=$?
if [ $retVal -eq 0 ];
then
#mv /nas/share05/tools/ExtractTools/BANK_GUARANTEE/tmp/$yest /mnt/beegfs_bsl/live/DB_extract_lz/BANK_GUARANTEE/incoming
retVal=$?
if [ $retVal -eq 0 ];
then
