...
#                echo "work on anum: ${anum}"
                ...
                kv="\${DATE}=${DATE}"
                file_name="${DATE}_IFSAPP_BUDGET_COMM_COST_VAR.gz"
                log_file=${DATE}_IFSAPP_BUDGET_COMM_COST_VAR.log
...
#                file_name=".${DATE}IFSAPP_BUDGET_COMM_COST_VAR_${hour}_30_0${anum}.gz"
#                log_file=${DATE}IFSAPP_BUDGET_COMM_COST_VAR_${hour}_30_0${anum}.log
