...
rm -r /mnt/beegfs/tools/ExtractTools/CB_RETAIL_OUTLETS/logs/${removeDir}
...
bash /mnt/beegfs/tools/ExtractTools/INVENTORY_TRANSACTION_HIST/driver.sh /mnt/beegfs/tools/ExtractTools/INVENTORY_TRANSACTION_HIST /mnt/beegfs/tools/ExtractTools/INVENTORY_TRANSACTION_HIST/tmp/Omar $yest "1 2 3 4 9" 
retVal=$?
if [ $retVal -eq 0 ];
then
#mv /mnt/beegfs/FlareData/CDR/CB_RETAIL_OUTLETS/tmp/$yest /mnt/beegfs/FlareData/CDR/CB_RETAIL_OUTLETS/incoming/
retVal=$?
if [ $retVal -eq 0 ];
then
