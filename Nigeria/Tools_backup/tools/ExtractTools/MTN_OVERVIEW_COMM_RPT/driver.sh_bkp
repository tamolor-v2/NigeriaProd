...
#                echo "work on anum: ${anum}"
                ...
                kv="\${DATE}=${DATE}"
                file_name="${DATE}_MTN_OVERVIEW_COMM_RPT.gz"
                log_file=${DATE}_MTN_OVERVIEW_COMM_RPT.log
...
#                file_name=".${DATE}MTN_OVERVIEW_COMM_RPT_${hour}_30_0${anum}.gz"
#                log_file=${DATE}MTN_OVERVIEW_COMM_RPT_${hour}_30_0${anum}.log
