...
bash /nas/share05/tools/ExtractTools/scripts/replaceDump.sh DBA_ROLE_PRIVS ${yest}  


bash /nas/share05/tools/ExtractTools/DBA_ROLE_PRIVS/driver.sh /nas/share05/tools/ExtractTools/DBA_ROLE_PRIVS /nas/share05/tools/ExtractTools/DBA_ROLE_PRIVS/tmp $yest 
retVal=$?
if [ $retVal -eq 0 ];
then
mv /nas/share05/tools/ExtractTools/DBA_ROLE_PRIVS/tmp/$yest /mnt/beegfs_bsl/live/DB_extract_lz/DBA_ROLE_PRIVS/incoming
retVal=$?
if [ $retVal -eq 0 ];
then
