...
rm -r /nas/share05/tools/ExtractTools/PURCHASE_REQ_LINE/logs/${removeDir}
...
bash /nas/share05/tools/ExtractTools/scripts/replaceDump.sh PURCHASE_REQ_LINE ${yest} ${yest}
bash /nas/share05/tools/ExtractTools/PURCHASE_REQ_LINE/driver.sh /nas/share05/tools/ExtractTools/PURCHASE_REQ_LINE /nas/share05/tools/ExtractTools/PURCHASE_REQ_LINE/tmp $yest 
retVal=$?
if [ $retVal -eq 0 ];
then
mv /nas/share05/tools/ExtractTools/PURCHASE_REQ_LINE/tmp/$yest /mnt/beegfs_bsl/live/DB_extract_lz/PURCHASE_REQ_LINE/incoming
retVal=$?
if [ $retVal -eq 0 ];
then
