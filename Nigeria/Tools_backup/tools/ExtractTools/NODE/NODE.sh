...
rm -r /nas/share05/tools/ExtractTools/NODE/logs/${removeDir}
...
bash /nas/share05/tools/ExtractTools/scripts/replaceDump.sh NODE ${yest}  


bash /nas/share05/tools/ExtractTools/NODE/driver.sh /nas/share05/tools/ExtractTools/NODE /nas/share05/tools/ExtractTools/NODE/tmp $yest 
retVal=$?
if [ $retVal -eq 0 ];
then
mv /nas/share05/tools/ExtractTools/NODE/tmp/$yest /mnt/beegfs_bsl/live/DB_extract_lz/NODE/incoming
retVal=$?
if [ $retVal -eq 0 ];
then
