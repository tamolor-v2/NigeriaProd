...
rm -r /nas/share05/tools/ExtractTools/BFP_FAILURE_LOG/logs/${removeDir}
...
bash /nas/share05/tools/ExtractTools/BFP_FAILURE_LOG/driver.sh /nas/share05/tools/ExtractTools/BFP_FAILURE_LOG /nas/share05/tools/ExtractTools/BFP_FAILURE_LOG/tmp $yest 
retVal=$?
if [ $retVal -eq 0 ];
then
mv /nas/share05/tools/ExtractTools/BFP_FAILURE_LOG/tmp/$yest /mnt/beegfs_bsl/live/DB_extract_lz/BFP_FAILURE_LOG/incoming
retVal=$?
if [ $retVal -eq 0 ];
then
