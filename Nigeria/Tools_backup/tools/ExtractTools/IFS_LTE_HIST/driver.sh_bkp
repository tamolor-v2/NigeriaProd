...
#                kv="\${date}=${DATE};\${hour}=${hour};\${minS}=00;\${minE}=29;\${anum}=${anum}"
                file_name=".${DATE}_AYA_IFS_LTE_HIST.gz"
                log_file=${DATE}_AYA_IFS_LTE_HIST.log
                kv="\${DATE}=${DATE}"
...
#                file_name=".${DATE}_IFS_LTE_HIST_${hour}_30_0${anum}.gz"
#                log_file=${DATE}_IFS_LTE_HIST_${hour}_30_0${anum}.log
