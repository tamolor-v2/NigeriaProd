...
#                kv="\${date}=${DATE};\${hour}=${hour};\${minS}=00;\${minE}=29;\${anum}=${anum}"
                file_name=".${DATE}_PAYMENT_REPORT_ALL.gz"
                log_file=${DATE}_PAYMENT_REPORT_ALL.log
                kv="\${DATE}=${DATE}"
...
#                file_name=".${DATE}_PAYMENT_REPORT_ALL_${hour}_30_0${anum}.gz"
#                log_file=${DATE}_PAYMENT_REPORT_ALL_${hour}_30_0${anum}.log
