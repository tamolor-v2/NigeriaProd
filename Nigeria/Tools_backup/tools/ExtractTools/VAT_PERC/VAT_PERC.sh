...
rm -r /nas/share05/tools/ExtractTools/VAT_PERC/logs/${removeDir}
...
bash /nas/share05/tools/ExtractTools/scripts/replaceDump.sh VAT_PERC ${yest}
...
bash /nas/share05/tools/ExtractTools/VAT_PERC/driver.sh /nas/share05/tools/ExtractTools/VAT_PERC /nas/share05/tools/ExtractTools/VAT_PERC/tmp $yest 
retVal=$?
if [ $retVal -eq 0 ];
then
mv /nas/share05/tools/ExtractTools/VAT_PERC/tmp/$yest /mnt/beegfs_bsl/live/DB_extract_lz/VAT_PERC/incoming
retVal=$?
if [ $retVal -eq 0 ];
then
