...
rm -r /mnt/beegfs_bsl/tools/ExtractTools/bib_credit_control_report/logs/${removeDir}
...
bash /nas/share05/tools/ExtractTools/bib_credit_control_report/driver.sh /mnt/beegfs_bsl/tools/ExtractTools/bib_credit_control_report /mnt/beegfs_bsl/tools/ExtractTools/bib_credit_control_report/tmp $yest 
retVal=$?
if [ $retVal -eq 0 ];
then
kinit -k -t /etc/security/keytabs/daasuser.keytab daasuser@mtn.com
hadoop fs -rm -R hdfs://ngdaas/FlareData/output_8/bib_credit_control_report/tbl_dt=*/*
mv /mnt/beegfs_bsl/tools/ExtractTools/bib_credit_control_report/tmp/$yest/* /mnt/beegfs_bsl/live/bib_credit_control_report/incoming
retVal=$?
if [ $retVal -eq 0 ];
then
