...
#------------------
mytime=$(date +"%Y-%m-%d_%H-%M-%S")
time java -Xmx30g -Xms30g -Dlog4j.configurationFile=/mnt/beegfs/tools/fileOps/log4j2.xml -jar /mnt/beegfs/tools/fileOps/FileOps_2.11-0.1-SNAPSHOT_hdfs.jar -in /mnt/beegfs/production/live/NGVS_CDR/processed -out /mnt/beegfs/tools/Crontab/logs/list/${currDate} -od -tf 10 -nt 32 -dp 15 -of -op list -mv /mnt/beegfs/production/archived/NGVS_CDR/ -re -rg "^.*_([0-9]{8}).*$" -opp "|@1/"  -nosim -lbl move_live_proces_arch_NGVS_CDR 2>&1  |tee "/mnt/beegfs/tools/Crontab/logs/move/${currDate}/move_live_proces_arch_NGVS_CDR_$mytime.log"


#CS5_VTU_DUMP
#------------------
mytime=$(date +"%Y-%m-%d_%H-%M-%S")
time java -Xmx30g -Xms30g -Dlog4j.configurationFile=/mnt/beegfs/tools/fileOps/log4j2.xml -jar /mnt/beegfs/tools/fileOps/FileOps_2.11-0.1-SNAPSHOT_hdfs.jar -in /mnt/beegfs/production/live/CS5_VTU_DUMP/processed -out /mnt/beegfs/tools/Crontab/logs/list/${currDate} -od -tf 10 -nt 32 -dp 15 -of -op list -mv /mnt/beegfs/production/archived/CS5_VTU_DUMP/ -re -rg "^.*([0-9]{2})([0-9]{2})([0-9]{4}).*$" -opp "|@3|@1|@2/"  -nosim -lbl move_live_proces_arch_CS5_VTU_DUMP 2>&1  |tee "/mnt/beegfs/tools/Crontab/logs/move/${currDate}/move_live_proces_arch_CS5_VTU_DUMP_$mytime.log"
