...
?
time java -Xmx50g -Xms50g -jar -Dlog4j.configurationFile=./log4j2.xml ./FileOps_2.11-0.1-SNAPSHOT_hdfs.jar  -in $hdfs/AIR_ADJ_DA/$date $hdfs/AIR_ADJ_MA/$date $hdfs/AIR_REFILL_AC/$date $hdfs/AIR_REFILL_DA/$date $hdfs/AIR_REFILL_MA/$date $hdfs/BUNDLE4U_GPRS/$date $hdfs/BUNDLE4U_VOICE/$date $hdfs/CB_SERV_MAST_VIEW/$date $hdfs/CCN_GPRS_AC/$date $hdfs/CCN_GPRS_DA/$date $hdfs/CCN_GPRS_MA/$date $hdfs/CCN_SMS_AC/$date $hdfs/CCN_SMS_DA/$date $hdfs/CCN_SMS_MA/$date $hdfs/CCN_VOICE_AC/$date $hdfs/CCN_VOICE_DA/$date $hdfs/CCN_VOICE_MA/$date $hdfs/Containers/$date $hdfs/CUG_ACCESS_FEES/$date $hdfs/DMC_DUMP_ALL/$date $hdfs/DMC_DUMP_ALL_unsplitted/$date $hdfs/EWP_FINANCIAL_LOG/$date $hdfs/GGSN/$date $hdfs/HSDP/$date $hdfs/HSDP_tmp/$date $hdfs/MAPS_INV_2G/$date $hdfs/MAPS_INV_3G/$date $hdfs/MAPS_INV_4G/$date $hdfs/MOBILE_MONEY/$date $hdfs/MSC/$date $hdfs/SDP_ACC_ADJ_AC/$date $hdfs/SDP_ACC_ADJ_MA/$date $hdfs/SDP_ADJ_DA/$date $hdfs/SDP_DMP_MA/$date $hdfs/SGSN/$date $hdfs/WBS_PM_RATED_CDRS/$date $hdfs/SDP_DUMP_SUBSCRIBER/$date $hdfs/SDP_DUMP_OFFER/$date $hdfs/RECON/$date $hdfs/DPI/$date $hdfs/AGL_CRM_COUNTRY_MAP/$date $hdfs/AGL_CRM_LGA_MAP/$date $hdfs/AGL_CRM_STATE_MAP/$date $hdfs/CALL_REASON/$date $hdfs/CALL_REASON_MONTHLY/$date $hdfs/MNP_PORTING_BROADCAST/$date $hdfs/MVAS_DND_MSISDN_REP_CDR/$date $hdfs/NEWREG_BIOUPDT_POOL/$date $hdfs/SDP_DMP_DA/$date $hdfs/LBN/$date $hdfs/UDC_DUMP/$date $hdfs/CB_NEWREG_BIOUPDT_POOL_DAILY/$date $hdfs/NEWREG_BIOUPDT_POOL_WEEKLY/$date $hdfs/MSC_DAAS/$date $hdfs/MSC_DAAS/$date $hdfs/MSC_DAAS/$date $hdfs/MSC_DAAS/$date $hdfs/MSC_DAAS/$date $hdfs/MSC_DAAS/$date $hdfs/MSC_DAAS/$date $hdfs/MSC_DAAS/$date $hdfs/MSC_DAAS/$date $hdfs/MSC_DAAS/$date $hdfs/MSC_DAAS/$date $hdfs/MSC_DAAS/$date $hdfs/MSC_DAAS/$date $hdfs/MSC_DAAS/$date $hdfs/MSC_DAAS/$date $hdfs/MSC_DAAS/$date $hdfs/MSC_DAAS/$date $hdfs/MSC_DAAS/$date $hdfs/MSC_DAAS/$date $hdfs/MSC_DAAS/$date $hdfs/MSC_DAAS/$date $hdfs/MSC_DAAS/$date $hdfs/MSC_DAAS/$date $hdfs/MSC_DAAS/$date $hdfs/MSC_DAAS/$date $hdfs/MSC_DAAS/$date $hdfs/MSC_DAAS/$date $hdfs/MSC_DAAS/$date $hdfs/MSC_DAAS/$date $hdfs/MSC_DAAS/$date $hdfs/MSC_DAAS/$date $hdfs/MSC_DAAS/$date $hdfs/MSC_DAAS/$date $hdfs/CIS_CDR/$date $hdfs/MSC_DAAS/$date $hdfs/CIS_CDR/$date $hdfs/MSC_DAAS/$date $hdfs/CIS_CDR/$date $hdfs/NGVS_CDR/$date $hdfs/CS5_VTU_DUMP/$date -nt 32 -vad -rmp $from/#fn/$date/$date -out $report_folder -dp 15 -tf 1 -nosim -lbl double_taring_delete_ -of -od -fnfp 2 -hdfs "hdfs://ngdaas/" -kktf "/etc/security/keytabs/flare.keytab" -kp "flare@MTN.COM" -fromHdfs
?
