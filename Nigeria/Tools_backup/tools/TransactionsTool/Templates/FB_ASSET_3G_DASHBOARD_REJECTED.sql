start transaction;
delete from flare_8.vw_mtnn_asset_extract_3g_cells_rejected where tbl_dt >= firstDayOfpreviousMonth ;  
insert into  flare_8.vw_mtnn_asset_extract_3g_cells_rejected
select  
