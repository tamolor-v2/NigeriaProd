start transaction;
delete from flare_8.vw_MTNN_ASSET_EXTRACT_3G_CELLS_dq_issues  where tbl_dt >= firstDayOfpreviousMonth ; 
commit;
start transaction;
insert into flare_8.vw_MTNN_ASSET_EXTRACT_3G_CELLS_dq_issues 
...
select 
	...
	*
from flare_8.MTNN_ASSET_EXTRACT_3G_CELLS  where tbl_dt >= firstDayOfpreviousMonth and tbl_dt<= lastDayOfLastMonth)
select * 
from cell_info_test 
