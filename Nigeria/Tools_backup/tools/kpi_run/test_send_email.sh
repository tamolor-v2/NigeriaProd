...
echo "To: bmustafa@ligadata.com, krishna@ligadata.com, wsbayee@ligadata.com,  hendre@ligadata.com,  pokuri@ligadata.com,peter.mahlangu@ligadata.com,saleh@ligadata.com,yulbeh@ligadata.com,timipa@ligadata.com,a.sady@ligadata.com"
...
echo "<table border=1>
      ...
      <tr><td>KPI-000007</td><td>Mobile - Active Data Subscribers (Active RGS30)                     </td><td>"$(cut -d'|' -f7 <<< $kpiDay1)" </td><td>"$(cut -d'|' -f7 <<< $kpiDay2)" </td><td>"$(cut -d'|' -f7 <<< $kpiDay3)" </td></tr>
      <tr><td>KPI-000008</td><td>Mobile - Data Subscribers (Active RGS30)                            </td><td>"$(cut -d'|' -f8 <<< $kpiDay1)" </td><td>"$(cut -d'|' -f8 <<< $kpiDay2)" </td><td>"$(cut -d'|' -f8 <<< $kpiDay3)" </td></tr>
      <tr><td>KPI-000009</td><td>Mobile Money Subscribers (Active RGS30)                             </td><td>"$(cut -d'|' -f9 <<< $kpiDay1)" </td><td>"$(cut -d'|' -f9 <<< $kpiDay2)" </td><td>"$(cut -d'|' -f9 <<< $kpiDay3)" </td></tr>
      <tr><td>KPI-000010</td><td>Mobile Digital Service Subscribers (Active RGS30)                   </td><td>"$(cut -d'|' -f10 <<< $kpiDay1)"</td><td>"$(cut -d'|' -f10 <<< $kpiDay2)"</td><td>"$(cut -d'|' -f10 <<< $kpiDay3)"</td></tr>
      <tr><td>KPI-000011</td><td>Mobile - SMS subscribers (Active RGS30)                             </td><td>"$(cut -d'|' -f11 <<< $kpiDay1)"</td><td>"$(cut -d'|' -f11 <<< $kpiDay2)"</td><td>"$(cut -d'|' -f11 <<< $kpiDay3)"</td></tr>
