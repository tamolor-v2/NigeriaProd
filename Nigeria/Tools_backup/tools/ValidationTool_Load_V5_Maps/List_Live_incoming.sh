...
#--------------------------
PIDFILE=/home/daasuser/PIDFiles/list_file_incomingV5_Maps.pid
check_pid_file(){
if [ -f $PIDFILE ]
then
  PID=$(cat $PIDFILE)
...
time java -Xmx30g -Xms30g -Dlog4j.configurationFile=/mnt/beegfs/tools/fileOps/log4j2.xml -jar /mnt/beegfs/tools/fileOps/FileOps_2.11-0.1-SNAPSHOT_hdfs.jar  -in /mnt/beegfs/live/MAPS_2G_CELL_D/incoming /mnt/beegfs/live/MAPS_2G_CELL_W_BH/incoming /mnt/beegfs/live/MAPS_3G_CELL_D/incoming /mnt/beegfs/live/MAPS_3G_CELL_D_BH/incoming /mnt/beegfs/live/MAPS_3G_CELL_W/incoming /mnt/beegfs/live/MAPS_3G_CELL_M/incoming /mnt/beegfs/live/MAPS_3G_CELL_M_BH/incoming /mnt/beegfs/live/MAPS_3G_CN_D/incoming /mnt/beegfs/live/MAPS_3G_CN_D_BH/incoming /mnt/beegfs/live/MAPS_3G_CN_W_BH/incoming /mnt/beegfs/live/MAPS_3G_CN_M/incoming /mnt/beegfs/live/MAPS_3G_CN_W/incoming /mnt/beegfs/live/MAPS_2G_CN_M_DATA_BH/incoming /mnt/beegfs/live/MAPS_2G_CN_W_BH/incoming -out /mnt/beegfs/tools/Crontab/listIncoming/${today} -od -tf 20 -nt 32 -dp 5 -of -effl "^.*\.tmp$" -op list -lbl listIncomingLive 2>&1 | tee "/mnt/beegfs/tools/Crontab/listIncoming/${today}/list_live_Incoming${mytime}.log"
