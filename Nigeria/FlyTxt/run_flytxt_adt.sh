...
bash run_this_adt.sh $startdate $enddate datapackbalance flytxt
...
bash run_this_adt.sh $startdate $enddate cm_profile_bdail_momo_fee flytxt
bash run_this_adt.sh $startdate $enddate cm_profile_bdail_events flytxt
bash run_this_adt.sh $startdate $enddate cm_profile_bdail_recharge flytxt
bash run_this_adt.sh $startdate $enddate cm_profile_bdail flytxt
...
bash run_flytxt_spool_adt.sh $enddate > /dev/null 
