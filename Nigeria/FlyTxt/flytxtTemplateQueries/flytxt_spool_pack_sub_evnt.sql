...
vas_event_type_identifier as VAS_EVENT_TYPE_ID,
VALIDITY,
...
case when product_id is null then '' when product_id='null' then '' when product_id='NULL' then '' else product_id end as PRODUCT_ID
from nigeria.cm_pack_sub_evnt_sit_f;