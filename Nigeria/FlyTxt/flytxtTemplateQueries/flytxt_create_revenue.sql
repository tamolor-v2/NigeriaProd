start transaction;
delete from nigeria.cm_revenue_sit_f where part_key=99;
insert into nigeria.cm_revenue_sit_f
...
Total_Data_Bundled_Revenue,International_SMS_Revenue,International_Data_Revenue,Total_IC_Revenue,99 
