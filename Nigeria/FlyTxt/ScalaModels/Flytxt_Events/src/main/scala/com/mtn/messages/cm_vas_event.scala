...
object cm_vas_event extends RDDObject[cm_vas_event] with MessageFactoryInterface { 
  ...
  override def getTimePartitionInfo: TimePartitionInfo = {
    ...
    override def convertFrom(newVerObj: Any, oldVerobj: Any): ContainerInterface = {
      ...
      case oldVerobj: com.mtn.messages.V1000000.cm_vas_event => { return  convertToVer1000000(oldVerobj); } 
          case _ => {
    ...
    private def convertToVer1000000(oldVerobj: com.mtn.messages.V1000000.cm_vas_event): com.mtn.messages.V1000000.cm_vas_event= {
      return oldVerobj
    }
