...
object cm_pack_sub_event extends RDDObject[cm_pack_sub_event] with MessageFactoryInterface { 
  ...
  override def getTimePartitionInfo: TimePartitionInfo = {
    ...
    override def convertFrom(newVerObj: Any, oldVerobj: Any): ContainerInterface = {
      ...
      case oldVerobj: com.mtn.messages.cm_pack_sub_event => { return  convertToVer1000000(oldVerobj); } 
          case _ => {
    ...
    private def convertToVer1000000(oldVerobj: com.mtn.messages.cm_pack_sub_event): com.mtn.messages.cm_pack_sub_event= {
      return oldVerobj
    }
