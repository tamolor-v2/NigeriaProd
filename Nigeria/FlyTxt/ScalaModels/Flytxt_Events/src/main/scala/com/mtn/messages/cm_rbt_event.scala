...
object cm_rbt_event extends RDDObject[cm_rbt_event] with MessageFactoryInterface { 
 
  val log = LogManager.getLogger(getClass)
	type T = cm_rbt_event ;
	override def getFullTypeName: String = "com.mtn.messages.cm_rbt_event"; 
	override def getTypeNameSpace: String = "com.mtn.messages"; 
	override def getTypeName: String = "cm_rbt_event"; 
	override def getTypeVersion: String = "000000.000001.000000"; 
	override def getSchemaId: Int = 2005529; 
	...
	override def createInstance: cm_rbt_event = new cm_rbt_event(cm_rbt_event); 
  ...
  override def getTimePartitionInfo: TimePartitionInfo = {
    ...
    private def generateAttributeTypes(): Array[AttributeTypeInfo] = {
      ...
      return attributeTypes
		 ...
		 var keyTypes: Map[String, AttributeTypeInfo] = attributeTypes.map { a => (a.getName, a) }.toMap;
				def setFn0(curObj: cm_rbt_event, value: Any): Unit ={ 
				if(value.isInstanceOf[Long]) 
				  curObj.msisdn_key = value.asInstanceOf[Long]; 
				 else throw new Exception(s"Value is the not the correct type Long for field msisdn_key in message cm_rbt_event") 
				} 
				def setFn1(curObj: cm_rbt_event, value: Any): Unit ={ 
				if(value.isInstanceOf[Int]){ 
				  curObj.tbl_dt = value.asInstanceOf[Int]; 
				  curObj.setTimePartitionData; 
				} else throw new Exception(s"Value is the not the correct type Int for field tbl_dt in message cm_rbt_event") 
				} 
				def setFn2(curObj: cm_rbt_event, value: Any): Unit ={ 
				if(value.isInstanceOf[String]) 
				  curObj.original_timestamp = value.asInstanceOf[String]; 
				 else throw new Exception(s"Value is the not the correct type String for field original_timestamp in message cm_rbt_event") 
				} 
				def setFn3(curObj: cm_rbt_event, value: Any): Unit ={ 
				if(value.isInstanceOf[String]) 
				  curObj.value_of_pack = value.asInstanceOf[String]; 
				 else throw new Exception(s"Value is the not the correct type String for field value_of_pack in message cm_rbt_event") 
				} 
				def setFn4(curObj: cm_rbt_event, value: Any): Unit ={ 
				if(value.isInstanceOf[String]) 
				  curObj.name_of_pack = value.asInstanceOf[String]; 
				 else throw new Exception(s"Value is the not the correct type String for field name_of_pack in message cm_rbt_event") 
				} 
				def setFn5(curObj: cm_rbt_event, value: Any): Unit ={ 
				if(value.isInstanceOf[Int]) 
				  curObj.vas_event_type_identifier = value.asInstanceOf[Int]; 
				 else throw new Exception(s"Value is the not the correct type Int for field vas_event_type_identifier in message cm_rbt_event") 
				} 
				def setFn6(curObj: cm_rbt_event, value: Any): Unit ={ 
				if(value.isInstanceOf[Int]) 
				  curObj.validity = value.asInstanceOf[Int]; 
				 else throw new Exception(s"Value is the not the correct type Int for field validity in message cm_rbt_event") 
				} 
				def setFn7(curObj: cm_rbt_event, value: Any): Unit ={ 
				if(value.isInstanceOf[String]) 
				  curObj.main_balance_before_event = value.asInstanceOf[String]; 
				 else throw new Exception(s"Value is the not the correct type String for field main_balance_before_event in message cm_rbt_event") 
				} 
				def setFn8(curObj: cm_rbt_event, value: Any): Unit ={ 
				if(value.isInstanceOf[String]) 
				  curObj.main_balance_after_event = value.asInstanceOf[String]; 
				 else throw new Exception(s"Value is the not the correct type String for field main_balance_after_event in message cm_rbt_event") 
				} 
				def setFn9(curObj: cm_rbt_event, value: Any): Unit ={ 
				if(value.isInstanceOf[String]) 
				  curObj.product_id = value.asInstanceOf[String]; 
				 else throw new Exception(s"Value is the not the correct type String for field product_id in message cm_rbt_event") 
				} 

    val setFnArr = Array[(cm_rbt_event, Any) => Unit](setFn0,setFn1,setFn2,setFn3,setFn4,setFn5,setFn6,setFn7,setFn8,setFn9    )
		def getFn0(curObj: cm_rbt_event): AnyRef = curObj.msisdn_key.asInstanceOf[AnyRef]; 
		def getFn1(curObj: cm_rbt_event): AnyRef = curObj.tbl_dt.asInstanceOf[AnyRef]; 
		def getFn2(curObj: cm_rbt_event): AnyRef = curObj.original_timestamp.asInstanceOf[AnyRef]; 
		def getFn3(curObj: cm_rbt_event): AnyRef = curObj.value_of_pack.asInstanceOf[AnyRef]; 
		def getFn4(curObj: cm_rbt_event): AnyRef = curObj.name_of_pack.asInstanceOf[AnyRef]; 
		def getFn5(curObj: cm_rbt_event): AnyRef = curObj.vas_event_type_identifier.asInstanceOf[AnyRef]; 
		def getFn6(curObj: cm_rbt_event): AnyRef = curObj.validity.asInstanceOf[AnyRef]; 
		def getFn7(curObj: cm_rbt_event): AnyRef = curObj.main_balance_before_event.asInstanceOf[AnyRef]; 
		def getFn8(curObj: cm_rbt_event): AnyRef = curObj.main_balance_after_event.asInstanceOf[AnyRef]; 
		def getFn9(curObj: cm_rbt_event): AnyRef = curObj.product_id.asInstanceOf[AnyRef]; 

    val getFnArr = Array[(cm_rbt_event) => AnyRef](getFn0,getFn1,getFn2,getFn3,getFn4,getFn5,getFn6,getFn7,getFn8,getFn9    )



    override def getRDDObject(): RDDObject[ContainerInterface] = cm_rbt_event.asInstanceOf[RDDObject[ContainerInterface]];
    ...
    override def convertFrom(newVerObj: Any, oldVerobj: Any): ContainerInterface = {
      ...
      case oldVerobj: com.mtn.messages.V1000000.cm_rbt_event => { return  convertToVer1000000(oldVerobj); } 
          case _ => {
    ...
    private def convertToVer1000000(oldVerobj: com.mtn.messages.V1000000.cm_rbt_event): com.mtn.messages.V1000000.cm_rbt_event= {
      return oldVerobj
    }
  ...
  override def PartitionKeyData(inputdata: InputData): Array[String] = { throw new Exception("Deprecated method PartitionKeyData in obj cm_rbt_event") };
  override def PrimaryKeyData(inputdata: InputData): Array[String] = throw new Exception("Deprecated method PrimaryKeyData in obj cm_rbt_event");
  override def TimePartitionData(inputdata: InputData): Long = throw new Exception("Deprecated method TimePartitionData in obj cm_rbt_event");
 override def NeedToTransformData: Boolean = false
    }

class cm_rbt_event(factory: MessageFactoryInterface, other: cm_rbt_event) extends MessageInterface(factory) { 
 
  val log = cm_rbt_event.log

      var attributeTypes = cm_rbt_event.attributeTypes
      
		 var keyTypes = cm_rbt_event.keyTypes;
    ...
    override def save: Unit = { cm_rbt_event.saveOne(this) }
  
    def Clone(): ContainerOrConcept = { cm_rbt_event.build(this) }
    ...
    override def getAttributeType(name: String): AttributeTypeInfo = {
      ...
      var setFnArr = cm_rbt_event.setFnArr
    
      var getFnArr = cm_rbt_event.getFnArr
    ...
    private def getWithReflection(keyName: String): AnyRef = {
      ...
      val fieldX = ru.typeOf[cm_rbt_event].declaration(ru.newTermName(key)).asTerm.accessed.asTerm
    ...
    private def getByName(keyName: String): AnyRef = {
     if(keyName == null || keyName.trim.size == 0) throw new Exception("Please provide proper key name "+keyName);
      ...
      if (!keyTypes.contains(key)) throw new KeyNotFoundException(s"Key $key does not exists in message/container cm_rbt_event", null);
    ...
    override def get(index : Int) : AnyRef = {
      ...
      throw new Exception(s"$index is out of range for message cm_rbt_event");
    }
    ...
    override def set(keyName: String, value: Any) = {
      ...
      try {
  			 ...
  			 if (!keyTypes.contains(key)) throw new KeyNotFoundException(s"Key $key does not exists in message cm_rbt_event", null)
    ...
    def set(index : Int, value :Any): Unit = {
      if (value == null) throw new Exception(s"Value is null for index $index in message cm_rbt_event ")
      if (index < 0 || index >= setFnArr.length) throw new Exception(s"$index is out of range for message cm_rbt_event ")
    ...
    private def fromFunc(other: cm_rbt_event): cm_rbt_event = {  
  ...
  private def getKeyValueByteArray(value: Any): Array[Byte] = {
    ...
    value match {
 	 ...
 	 def withmsisdn_key(value: Long) : cm_rbt_event = {
		 this.msisdn_key = value 
		 return this 
 	 } 
	 def withtbl_dt(value: Int) : cm_rbt_event = {
		 this.tbl_dt = value 
		 return this 
 	 } 
	 def withoriginal_timestamp(value: String) : cm_rbt_event = {
		 this.original_timestamp = value 
		 return this 
 	 } 
	 def withvalue_of_pack(value: String) : cm_rbt_event = {
		 this.value_of_pack = value 
		 return this 
 	 } 
	 def withname_of_pack(value: String) : cm_rbt_event = {
		 this.name_of_pack = value 
		 return this 
 	 } 
	 def withvas_event_type_identifier(value: Int) : cm_rbt_event = {
		 this.vas_event_type_identifier = value 
		 return this 
 	 } 
	 def withvalidity(value: Int) : cm_rbt_event = {
		 this.validity = value 
		 return this 
 	 } 
	 def withmain_balance_before_event(value: String) : cm_rbt_event = {
		 this.main_balance_before_event = value 
		 return this 
 	 } 
	 def withmain_balance_after_event(value: String) : cm_rbt_event = {
		 this.main_balance_after_event = value 
		 return this 
 	 } 
	 def withproduct_id(value: String) : cm_rbt_event = {
    ...
    override def getRDDObject(): RDDObject[ContainerInterface] = cm_rbt_event.asInstanceOf[RDDObject[ContainerInterface]];
        ...
        def isCaseSensitive(): Boolean = cm_rbt_event.isCaseSensitive(); 
