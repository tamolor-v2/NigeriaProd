...
object CS5_CCN_GPRS_MA extends RDDObject[CS5_CCN_GPRS_MA] with MessageFactoryInterface { 
  ...
  override def getTimePartitionInfo: TimePartitionInfo = {
    ...
    override def convertFrom(newVerObj: Any, oldVerobj: Any): ContainerInterface = {
      ...
      case oldVerobj: com.mtn.messages.V1000000.CS5_CCN_GPRS_MA => { return  convertToVer1000000(oldVerobj); } 
          case _ => {
    ...
    private def convertToVer1000000(oldVerobj: com.mtn.messages.V1000000.CS5_CCN_GPRS_MA): com.mtn.messages.V1000000.CS5_CCN_GPRS_MA= {
      return oldVerobj
    }
