...
object CS5_AIR_REFILL_MA extends RDDObject[CS5_AIR_REFILL_MA] with MessageFactoryInterface { 
  ...
  override def getTimePartitionInfo: TimePartitionInfo = {
    ...
    override def convertFrom(newVerObj: Any, oldVerobj: Any): ContainerInterface = {
      ...
      case oldVerobj: com.mtn.messages.V1000000.CS5_AIR_REFILL_MA => { return  convertToVer1000000(oldVerobj); } 
          case _ => {
    ...
    private def convertToVer1000000(oldVerobj: com.mtn.messages.V1000000.CS5_AIR_REFILL_MA): com.mtn.messages.V1000000.CS5_AIR_REFILL_MA= {
      return oldVerobj
    }
