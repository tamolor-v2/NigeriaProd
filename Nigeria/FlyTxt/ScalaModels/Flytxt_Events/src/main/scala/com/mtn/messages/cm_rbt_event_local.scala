...
object cm_rbt_event extends RDDObject[cm_rbt_event] with MessageFactoryInterface { 
  ...
  override def getTimePartitionInfo: TimePartitionInfo = {
    ...
    override def convertFrom(newVerObj: Any, oldVerobj: Any): ContainerInterface = {
      ...
      case oldVerobj: com.mtn.messages.cm_rbt_event => { return  convertToVer1000000(oldVerobj); } 
          case _ => {
    ...
    private def convertToVer1000000(oldVerobj: com.mtn.messages.cm_rbt_event): com.mtn.messages.cm_rbt_event= {
      return oldVerobj
    }
