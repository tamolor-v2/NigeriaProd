...
object cm_refill_event extends RDDObject[cm_refill_event] with MessageFactoryInterface { 
  ...
  override def getTimePartitionInfo: TimePartitionInfo = {
    ...
    override def convertFrom(newVerObj: Any, oldVerobj: Any): ContainerInterface = {
      ...
      case oldVerobj: com.mtn.messages.V1000000.cm_refill_event => { return  convertToVer1000000(oldVerobj); } 
          case _ => {
    ...
    private def convertToVer1000000(oldVerobj: com.mtn.messages.V1000000.cm_refill_event): com.mtn.messages.V1000000.cm_refill_event= {
      return oldVerobj
    }
