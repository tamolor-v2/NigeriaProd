...
dag = DAG(
    dag_id='CS18_Daily_Cluster_xtratime_comm_recovery',
    default_args=args,
...
DAILY_CDR_SUMMARY = BashOperator(
     task_id='Daily_xtratime_comm_recovery' ,
     depends_on_past=False,
     bash_command='/nas/share05/dataOps_prod/pr/cs18_reports.py -p DAILY_CDR_SUMMARY -s `date --date="-1 days" +%Y-%m-%d` -l 10',
     dag=dag,
...
DAILY_CDR_SUMMARY >> chatbox >> EVD_BY_PARTNER >> MYMTNAPPS >> SHORT_CODE >> CS18_MOU >> M2M_OFFERS
