...
VOICE >> post_usage_summary
VAS >> post_usage_summary
SMS >> post_usage_summary
GPRS >> post_usage_summary
OTHER_VAS >> post_usage_summary
PAYMENTS >> post_usage_summary

vas_revenue >> subsmartdevnew
post_usage_summary >> ncc_events >> ncc_bsl >> ncc_customersubject_consolidated >> subsmartdevnew
cs_check_trend >> GROSS_ACT_REGION >> gross_connection >> gross_conn_check >> [kitchen_activations , sub_metrics ] >> sub_metrics_check  >> metrics >> metrics_check
