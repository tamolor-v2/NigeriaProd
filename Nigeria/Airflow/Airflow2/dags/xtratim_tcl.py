...
dag = DAG(
    ...
    description='xtratime_tcl_loan_dashboard',
    catchup=False,
    concurrency=2,
    max_active_runs=2
)
RUN_promo_code = BashOperator(
     task_id='RUN_xtratime_tcl' ,
     bash_command='python3.6 /nas/share05/dataOps_dev/loan_recovery/loan_reports_tcl_dly.py {0} {0} 0 '.format(date_param),
     dag=dag,
