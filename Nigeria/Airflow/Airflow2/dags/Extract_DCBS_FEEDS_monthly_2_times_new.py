...
dag = DAG(
    dag_id='Extract_DCBS_FEEDS_monthly_2_times_new',
    default_args=args,
    schedule_interval='30 5 6,7 * *',
    catchup=False,
    concurrency=1,
    max_active_runs=1
)
...
extract_002_DCBS_REPORTS_BILLING_ACCOUNT_SUMMARY_FIN_monthly_yest = BashOperator(
     task_id='extract_002_DCBS_REPORTS_BILLING_ACCOUNT_SUMMARY_FIN_monthly_yest' ,
     bash_command='bash /nas/share05/tools/FeedsExtractor/Scripts/Airflow_DAG/DCBS_Feeds/extract_002_DCBS_REPORTS_BILLING_ACCOUNT_SUMMARY_FIN_monthly_yest.sh ',
     dag=dag,
     run_as_user = 'daasuser'
)

extract_17_DCBS_REPORTS_TAX_INVOICE_VW_monthly_yest >> extract_18_DCBS_REPORTS_ACCOUNT_SUMMARY_monthly_yest >> extract_02_DCBS_REPORTS_FIFO_SERV_AGEING_REPORT_VW_monthly_yest >> extract_002_DCBS_REPORTS_BILLING_ACCOUNT_SUMMARY_FIN_monthly_yest
