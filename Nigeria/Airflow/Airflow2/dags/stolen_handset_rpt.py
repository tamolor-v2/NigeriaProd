...
dag = DAG(
    dag_id='stolen_handset_rpt',
    default_args=args,
    schedule_interval='0 07 * * *',
    description='stolen_handset_rpt',
    catchup=False,
    concurrency=3,
    max_active_runs=3
)
retailer_incentive = BashOperator(
     task_id='stolen_handset_rpt' ,
     bash_command='python3.6 /nas/share05/dataOps_prod/stolen_handset_report/stolen_handset_report.py {0} {0} 0 '.format(date_param) ,
     dag=dag,
