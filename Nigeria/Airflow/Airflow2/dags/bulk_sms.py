...
bulk_sms = BashOperator(
     task_id='bulk_sms' ,
     bash_command='python3.6 /nas/share05/ops/mtnops/bulk_sms.py -l 1 -s `date --date="-7 days" +%Y-%m-%d` && python3.6 /nas/share05/ops/mtnops/bulk_sms.py -l 1 -s `date --date="-6 days" +%Y-%m-%d` && python3.6 /nas/share05/ops/mtnops/bulk_sms.py -l 1 -s `date --date="-5 days" +%Y-%m-%d` && python3.6 /nas/share05/ops/mtnops/bulk_sms.py -l 1 -s `date --date="-4 days" +%Y-%m-%d` && python3.6 /nas/share05/ops/mtnops/bulk_sms.py -l 1 -s `date --date="-3 days" +%Y-%m-%d` && python3.6 /nas/share05/ops/mtnops/bulk_sms.py -l 1 -s `date --date="-2 days" +%Y-%m-%d` && python3.6 /nas/share05/ops/mtnops/bulk_sms.py -l 1 -s `date --date="-1 days" +%Y-%m-%d` && python3.6 /nas/share05/ops/mtnops/bulk_sms.py -l 1 -s `date --date="-0 days" +%Y-%m-%d`',
     dag=dag,
