...
#t6 = BashOperator(
#     task_id='USSD1' ,
#     bash_command='bash /nas/share05/tools/USSDReport/USSD_REPORT_Test.sh `date --date="-1 days" +%Y%m%d`',
#     dag=dag,
 #    run_as_user = 'daasuser'
#)
...
#t7 = BashOperator(
 #    task_id='USSD2' ,
#     bash_command='bash /nas/share05/tools/USSDReport/USSD_REPORT_remi.sh `date --date="-1 days" +%Y%m%d`',
#     dag=dag,
#     run_as_user = 'daasuser'
#)
