...
dag = DAG(
    dag_id='eb_fusion_nin_report',
    default_args=args,
    schedule_interval='0 09 * * *',
    description='eb_fusion_nin_report',
    catchup=False,
    concurrency=2,
    max_active_runs=2
)
RUN_SOLO_DEV = BashOperator(
     ...
     bash_command='python3.6 /nas/share05/dataOps_dev/eb_fusion_nin/eb_fusion_report.py {0} {0} 1 '.format(date_param) ,
     dag=dag,
