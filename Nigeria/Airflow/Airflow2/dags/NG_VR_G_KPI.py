...
branchScript_AGL_BILL_ANALYZER_MONTHLY = "scala -cp /nas/share05/tools/DQ/lib/presto-jdbc-0.99.jar:/nas/share05/tools/DQ/lib/CheckValidation-1.0.0.jar com.ligadata.cv.CheckValidationTable -feedname {0} -date {1} -sleeptime {2} -retry 200 -outPath {3} -rundate {4} -hour {5}".format(feedname2_AGL_BILL_ANALYZER_MONTHLY,d_1,sleeptime,pathcsv,run_date,hour_run)
...
branchScript_BILL_RUN_STATISTICS_TAB = "scala -cp /nas/share05/tools/DQ/lib/presto-jdbc-0.99.jar:/nas/share05/tools/DQ/lib/CheckValidation-1.0.0.jar com.ligadata.cv.CheckValidationTable -feedname {0} -date {1} -sleeptime {2} -retry 200 -outPath {3} -rundate {4} -hour {5}".format(feedname2_BILL_RUN_STATISTICS_TAB,d_1,sleeptime,pathcsv,run_date,hour_run)
...
branchScript_BUDGET_YEAR_AMOUNT = "scala -cp /nas/share05/tools/DQ/lib/presto-jdbc-0.99.jar:/nas/share05/tools/DQ/lib/CheckValidation-1.0.0.jar com.ligadata.cv.CheckValidationTable -feedname {0} -date {1} -sleeptime {2} -retry 200 -outPath {3} -rundate {4} -hour {5}".format(feedname2_BUDGET_YEAR_AMOUNT,d_1,sleeptime,pathcsv,run_date,hour_run)
...
branchScript_CB_SCHEDULES = "scala -cp /nas/share05/tools/DQ/lib/presto-jdbc-0.99.jar:/nas/share05/tools/DQ/lib/CheckValidation-1.0.0.jar com.ligadata.cv.CheckValidationTable -feedname {0} -date {1} -sleeptime {2} -retry 200 -outPath {3} -rundate {4} -hour {5}".format(feedname2_CB_SCHEDULES,d_1,sleeptime,pathcsv,run_date,hour_run)
...
branchScript_CB_SUBS_POS_SERVICES = "scala -cp /nas/share05/tools/DQ/lib/presto-jdbc-0.99.jar:/nas/share05/tools/DQ/lib/CheckValidation-1.0.0.jar com.ligadata.cv.CheckValidationTable -feedname {0} -date {1} -sleeptime {2} -retry 200 -outPath {3} -rundate {4} -hour {5}".format(feedname2_CB_SUBS_POS_SERVICES,d_1,sleeptime,pathcsv,run_date,hour_run)
...
branchScript_CHANGE_REPORT_MTN = "scala -cp /nas/share05/tools/DQ/lib/presto-jdbc-0.99.jar:/nas/share05/tools/DQ/lib/CheckValidation-1.0.0.jar com.ligadata.cv.CheckValidationTable -feedname {0} -date {1} -sleeptime {2} -retry 200 -outPath {3} -rundate {4} -hour {5}".format(feedname2_CHANGE_REPORT_MTN,d_1,sleeptime,pathcsv,run_date,hour_run)
...
branchScript_CLIENT_ACTIVITY_LOG = "scala -cp /nas/share05/tools/DQ/lib/presto-jdbc-0.99.jar:/nas/share05/tools/DQ/lib/CheckValidation-1.0.0.jar com.ligadata.cv.CheckValidationTable -feedname {0} -date {1} -sleeptime {2} -retry 200 -outPath {3} -rundate {4} -hour {5}".format(feedname2_CLIENT_ACTIVITY_LOG,d_1,sleeptime,pathcsv,run_date,hour_run)
...
branchScript_HPD_HELP_DESK = "scala -cp /nas/share05/tools/DQ/lib/presto-jdbc-0.99.jar:/nas/share05/tools/DQ/lib/CheckValidation-1.0.0.jar com.ligadata.cv.CheckValidationTable -feedname {0} -date {1} -sleeptime {2} -retry 200 -outPath {3} -rundate {4} -hour {5}".format(feedname2_HPD_HELP_DESK,d_1,sleeptime,pathcsv,run_date,hour_run)
...
branchScript_MSO_ACCURACY_STATISTICS = "scala -cp /nas/share05/tools/DQ/lib/presto-jdbc-0.99.jar:/nas/share05/tools/DQ/lib/CheckValidation-1.0.0.jar com.ligadata.cv.CheckValidationTable -feedname {0} -date {1} -sleeptime {2} -retry 200 -outPath {3} -rundate {4} -hour {5}".format(feedname2_MSO_ACCURACY_STATISTICS,d_1,sleeptime,pathcsv,run_date,hour_run)
...
branchScript_MSO_PROCESS_AVG_TIME = "scala -cp /nas/share05/tools/DQ/lib/presto-jdbc-0.99.jar:/nas/share05/tools/DQ/lib/CheckValidation-1.0.0.jar com.ligadata.cv.CheckValidationTable -feedname {0} -date {1} -sleeptime {2} -retry 200 -outPath {3} -rundate {4} -hour {5}".format(feedname2_MSO_PROCESS_AVG_TIME,d_1,sleeptime,pathcsv,run_date,hour_run)
...
branchScript_MTN_OVERVIEW_COMM_RPT = "scala -cp /nas/share05/tools/DQ/lib/presto-jdbc-0.99.jar:/nas/share05/tools/DQ/lib/CheckValidation-1.0.0.jar com.ligadata.cv.CheckValidationTable -feedname {0} -date {1} -sleeptime {2} -retry 200 -outPath {3} -rundate {4} -hour {5}".format(feedname2_MTN_OVERVIEW_COMM_RPT,d_1,sleeptime,pathcsv,run_date,hour_run)
...
branchScript_MTN_PR_DETAILS = "scala -cp /nas/share05/tools/DQ/lib/presto-jdbc-0.99.jar:/nas/share05/tools/DQ/lib/CheckValidation-1.0.0.jar com.ligadata.cv.CheckValidationTable -feedname {0} -date {1} -sleeptime {2} -retry 200 -outPath {3} -rundate {4} -hour {5}".format(feedname2_MTN_PR_DETAILS,d_1,sleeptime,pathcsv,run_date,hour_run)
...
branchScript_OTP_STATUS = "scala -cp /nas/share05/tools/DQ/lib/presto-jdbc-0.99.jar:/nas/share05/tools/DQ/lib/CheckValidation-1.0.0.jar com.ligadata.cv.CheckValidationTable -feedname {0} -date {1} -sleeptime {2} -retry 200 -outPath {3} -rundate {4} -hour {5}".format(feedname2_OTP_STATUS,d_1,sleeptime,pathcsv,run_date,hour_run)
...
branchScript_SERV_STATUS_SEAMFIX_REF = "scala -cp /nas/share05/tools/DQ/lib/presto-jdbc-0.99.jar:/nas/share05/tools/DQ/lib/CheckValidation-1.0.0.jar com.ligadata.cv.CheckValidationTable -feedname {0} -date {1} -sleeptime {2} -retry 200 -outPath {3} -rundate {4} -hour {5}".format(feedname2_SERV_STATUS_SEAMFIX_REF,d_1,sleeptime,pathcsv,run_date,hour_run)
...
branchScript_SMS_ACTIVATION_REQUEST_JOIN = "scala -cp /nas/share05/tools/DQ/lib/presto-jdbc-0.99.jar:/nas/share05/tools/DQ/lib/CheckValidation-1.0.0.jar com.ligadata.cv.CheckValidationTable -feedname {0} -date {1} -sleeptime {2} -retry 200 -outPath {3} -rundate {4} -hour {5}".format(feedname2_SMS_ACTIVATION_REQUEST_JOIN,d_1,sleeptime,pathcsv,run_date,hour_run)
...
branchScript_SMS_ACTIVATION_VW = "scala -cp /nas/share05/tools/DQ/lib/presto-jdbc-0.99.jar:/nas/share05/tools/DQ/lib/CheckValidation-1.0.0.jar com.ligadata.cv.CheckValidationTable -feedname {0} -date {1} -sleeptime {2} -retry 200 -outPath {3} -rundate {4} -hour {5}".format(feedname2_SMS_ACTIVATION_VW,d_1,sleeptime,pathcsv,run_date,hour_run)
...
branchScript_VALIDATION_PASSED = "scala -cp /nas/share05/tools/DQ/lib/presto-jdbc-0.99.jar:/nas/share05/tools/DQ/lib/CheckValidation-1.0.0.jar com.ligadata.cv.CheckValidationTable -feedname {0} -date {1} -sleeptime {2} -retry 200 -outPath {3} -rundate {4} -hour {5}".format(feedname2_VALIDATION_PASSED,d_1,sleeptime,pathcsv,run_date,hour_run)
...
branchScript_SMS_ACTIVATION_REQUEST_KPI = "scala -cp /nas/share05/tools/DQ/lib/presto-jdbc-0.99.jar:/nas/share05/tools/DQ/lib/CheckValidation-1.0.0.jar com.ligadata.cv.CheckValidationTable -feedname {0} -date {1} -sleeptime {2} -retry 200 -outPath {3} -rundate {4} -hour {5}".format(feedname2_SMS_ACTIVATION_REQUEST_KPI,d_1,sleeptime,pathcsv,run_date,hour_run)
...
branchScript_RECHARGE_SUCCESS_RATE = "scala -cp /nas/share05/tools/DQ/lib/presto-jdbc-0.99.jar:/nas/share05/tools/DQ/lib/CheckValidation-1.0.0.jar com.ligadata.cv.CheckValidationTable -feedname {0} -date {1} -sleeptime {2} -retry 200 -outPath {3} -rundate {4} -hour {5}".format(feedname2_RECHARGE_SUCCESS_RATE,d_1,sleeptime,pathcsv,run_date,hour_run)
...
branchScript_USSD_ERROR_CODE_BREAKDOWN = "scala -cp /nas/share05/tools/DQ/lib/presto-jdbc-0.99.jar:/nas/share05/tools/DQ/lib/CheckValidation-1.0.0.jar com.ligadata.cv.CheckValidationTable -feedname {0} -date {1} -sleeptime {2} -retry 200 -outPath {3} -rundate {4} -hour {5}".format(feedname2_USSD_ERROR_CODE_BREAKDOWN,d_1,sleeptime,pathcsv,run_date,hour_run)
...
branchScript_AUDIT_LOGS = "scala -cp /nas/share05/tools/DQ/lib/presto-jdbc-0.99.jar:/nas/share05/tools/DQ/lib/CheckValidation-1.0.0.jar com.ligadata.cv.CheckValidationTable -feedname {0} -date {1} -sleeptime {2} -retry 200 -outPath {3} -rundate {4} -hour {5}".format(feedname2_AUDIT_LOGS,d_1,sleeptime,pathcsv,run_date,hour_run)
...
branchScript_DELIVERY_ERROR_BREAKDOWN_PER_TRAFFIC_TYPE = "scala -cp /nas/share05/tools/DQ/lib/presto-jdbc-0.99.jar:/nas/share05/tools/DQ/lib/CheckValidation-1.0.0.jar com.ligadata.cv.CheckValidationTable -feedname {0} -date {1} -sleeptime {2} -retry 200 -outPath {3} -rundate {4} -hour {5}".format(feedname2_DELIVERY_ERROR_BREAKDOWN_PER_TRAFFIC_TYPE,d_1,sleeptime,pathcsv,run_date,hour_run)
...
branchScript_SERVICE_USAGE_NOTIFICATION_DELIVERY_SUCCESS_RATE = "scala -cp /nas/share05/tools/DQ/lib/presto-jdbc-0.99.jar:/nas/share05/tools/DQ/lib/CheckValidation-1.0.0.jar com.ligadata.cv.CheckValidationTable -feedname {0} -date {1} -sleeptime {2} -retry 200 -outPath {3} -rundate {4} -hour {5}".format(feedname2_SERVICE_USAGE_NOTIFICATION_DELIVERY_SUCCESS_RATE,d_1,sleeptime,pathcsv,run_date,hour_run)
...
branchScript_EMM_DELIVERY_KPI = "scala -cp /nas/share05/tools/DQ/lib/presto-jdbc-0.99.jar:/nas/share05/tools/DQ/lib/CheckValidation-1.0.0.jar com.ligadata.cv.CheckValidationTable -feedname {0} -date {1} -sleeptime {2} -retry 200 -outPath {3} -rundate {4} -hour {5}".format(feedname2_EMM_DELIVERY_KPI,d_1,sleeptime,pathcsv,run_date,hour_run)
...
branchScript_FINANCIAL_LOG = "scala -cp /nas/share05/tools/DQ/lib/presto-jdbc-0.99.jar:/nas/share05/tools/DQ/lib/CheckValidation-1.0.0.jar com.ligadata.cv.CheckValidationTable -feedname {0} -date {1} -sleeptime {2} -retry 200 -outPath {3} -rundate {4} -hour {5}".format(feedname2_FINANCIAL_LOG,d_1,sleeptime,pathcsv,run_date,hour_run)
...
branchScript_MANUAL_KPI = "scala -cp /nas/share05/tools/DQ/lib/presto-jdbc-0.99.jar:/nas/share05/tools/DQ/lib/CheckValidation-1.0.0.jar com.ligadata.cv.CheckValidationTable -feedname {0} -date {1} -sleeptime {2} -retry 200 -outPath {3} -rundate {4} -hour {5}".format(feedname2_MANUAL_KPI,d_1,sleeptime,pathcsv,run_date,hour_run)
...
branchScript_ECW_TRANSACTION = "scala -cp /nas/share05/tools/DQ/lib/presto-jdbc-0.99.jar:/nas/share05/tools/DQ/lib/CheckValidation-1.0.0.jar com.ligadata.cv.CheckValidationTable -feedname {0} -date {1} -sleeptime {2} -retry 200 -outPath {3} -rundate {4} -hour {5}".format(feedname2_ECW_TRANSACTION,d_1,sleeptime,pathcsv,run_date,hour_run)
