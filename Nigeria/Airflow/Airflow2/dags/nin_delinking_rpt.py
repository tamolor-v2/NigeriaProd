...
dag = DAG(
    dag_id='nin_dlinking_rpt',
    default_args=args,
    schedule_interval='0 07 * * *',
    description='nin_dlinking_rpt',
    catchup=False,
    concurrency=3,
    max_active_runs=3
)
retailer_incentive = BashOperator(
     task_id='nin_dlinking_rpt' ,
     bash_command='python3.6 /nas/share05/dataOps_dev/nin_delinking/nin_dlinking_rpt.py {0} {0} 0 '.format(date_param) ,
     dag=dag,
