...
EPOSTPAID_VTU >> DYA_VISAFONE_REPORT >> VISAFONE_ADJ_REPORT >> STOCK_IN_CHANNEL_AGEING >> PREPAID_ROAMING_REV >> SMARTAPP_AND_DATARESET >> ADSL_OFFERS >> EPOSTPAID_DATA >> EXTRA_RENEWAL >> SHARE_AND_SELL >> SMS_REVENUE_MA >> SMS_REVENUE_DA
