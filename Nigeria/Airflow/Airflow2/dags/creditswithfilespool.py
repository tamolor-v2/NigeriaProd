...
dag = DAG(
    dag_id='creditswithfilespool',
    default_args=args,
    schedule_interval='0 07 * * *',
    description='creditswithfilespool',
    catchup=False,
    concurrency=3,
    max_active_runs=3
)
retailer_incentive = BashOperator(
     task_id='creditswithfilespool' ,
     bash_command='python3.6 /nas/share05/dataOps_dev/3pp_filepush/filepush_3pp_spool.py {0} {0} 0 '.format(date_param) ,
     dag=dag,
