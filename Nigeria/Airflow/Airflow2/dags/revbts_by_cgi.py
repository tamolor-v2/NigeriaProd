...
revbts_by_cgi = BashOperator(
     task_id='revbts_by_cgi' ,
     bash_command='python3.6 /nas/share05/ops/mtnops/revbts_by_cgi.py -l 1 -s {0}  '.format(date_param),
     dag=dag,
