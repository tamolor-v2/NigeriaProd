...
WBS_Summary >> DAILY_VOUCHER_REPORT_PRD >> hyconnect_inc_usage_sumd >> roaming_sumd >> payment_summary >> prepaid_activation >> D2C_REPORT >> INCOMING_TRAFFIC >> REP_INCOMING_TRAFFIC_MON >>  TRENDING_ON_OFF_VOICE >> SME_DATA_SHARE >> REV_PER_BTS_SUMD >> PREPAID_VAS_USSD >> PREPAID_ACT_DEALERS
