...
AGL_GDS_PROVIDER_CHILD = BashOperator(
     ...
     bash_command='/nas/share05/ops/mtnops/agl_gds_provider_child.py -p AGL_GDS_PROVIDER_CHILD ',
     depends_on_past=True,
     dag=dag,
     run_as_user = 'daasuser',
)
...
SMS_TRACKING_REPORT >> SMS_TRACKIN >> DAILY_MNP_TRANSACTIONS >> PORT_OUT >> repair >> XTRABITE_SUMMARY >> ERS_TRANSACTIONS >> card_load >> DOLA >> M2M_OFFERS >> CIS_CATALOGUE >> AGL_GDS_PROVIDER_CHILD
