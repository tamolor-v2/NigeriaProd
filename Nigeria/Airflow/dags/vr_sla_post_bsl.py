...
branchScript_MNP_PORTING_BROADCAST = "scala -cp /nas/share05/tools/DQ/lib/presto-jdbc-0.99.jar:/nas/share05/tools/DQ/lib/checkvalidation_2.11-1.0.0.jar com.ligadata.cv.CheckValidationTable -feedname {0} -date {1} -sleeptime {2} -retry 200 -outPath {3} -rundate {4} -hour {5}".format(feedname2_MNP_PORTING_BROADCAST,d_1,sleeptime,pathcsv,run_date,hour_run)
...
branchScript_NEWREG_BIOUPDT_POOL_DAILY = "scala -cp /nas/share05/tools/DQ/lib/presto-jdbc-0.99.jar:/nas/share05/tools/DQ/lib/checkvalidation_2.11-1.0.0.jar com.ligadata.cv.CheckValidationTable -feedname {0} -date {1} -sleeptime {2} -retry 200 -outPath {3} -rundate {4} -hour {5}".format(feedname2_NEWREG_BIOUPDT_POOL_DAILY,d_1,sleeptime,pathcsv,run_date,hour_run)
...
branchScript_NEWREG_BIOUPDT_POOL_WEEKLY = "scala -cp /nas/share05/tools/DQ/lib/presto-jdbc-0.99.jar:/nas/share05/tools/DQ/lib/checkvalidation_2.11-1.0.0.jar com.ligadata.cv.CheckValidationTable -feedname {0} -date {1} -sleeptime {2} -retry 200 -outPath {3} -rundate {4} -hour {5}".format(feedname2_NEWREG_BIOUPDT_POOL_WEEKLY,d_1,sleeptime,pathcsv,run_date,hour_run)
...
branchScript_NGVS_CDR = "scala -cp /nas/share05/tools/DQ/lib/presto-jdbc-0.99.jar:/nas/share05/tools/DQ/lib/checkvalidation_2.11-1.0.0.jar com.ligadata.cv.CheckValidationTable -feedname {0} -date {1} -sleeptime {2} -retry 200 -outPath {3} -rundate {4} -hour {5}".format(feedname2_NGVS_CDR,d_1,sleeptime,pathcsv,run_date,hour_run)
...
branchScript_OFFER_DUMP = "scala -cp /nas/share05/tools/DQ/lib/presto-jdbc-0.99.jar:/nas/share05/tools/DQ/lib/checkvalidation_2.11-1.0.0.jar com.ligadata.cv.CheckValidationTable -feedname {0} -date {1} -sleeptime {2} -retry 200 -outPath {3} -rundate {4} -hour {5}".format(feedname2_OFFER_DUMP,d_1,sleeptime,pathcsv,run_date,hour_run)
...
branchScript_WBS_PM_RATED_CDRS = "scala -cp /nas/share05/tools/DQ/lib/presto-jdbc-0.99.jar:/nas/share05/tools/DQ/lib/checkvalidation_2.11-1.0.0.jar com.ligadata.cv.CheckValidationTable -feedname {0} -date {1} -sleeptime {2} -retry 200 -outPath {3} -rundate {4} -hour {5}".format(feedname2_WBS_PM_RATED_CDRS,d_1,sleeptime,pathcsv,run_date,hour_run)
