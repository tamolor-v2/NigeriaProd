...
SIM_REG_PBI >> RECH_BY_VOUCHER >> Short_Code_Summary >> Smart_Apps_CDR >> top1000_log >> vtu_channel_sumd >> SDP_Bal_SC >> Service_Invoice >>  MODTRANSACTIONS_ACT >> RUN_REV >> Top1000 >>RATTYPE >> PORT_OUT_BALANCE
