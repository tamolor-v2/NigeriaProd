...
start_sms1 >> SRTT_CLOSED >> SRTT_CREATED >> END_SMS2 >> USSD_Summary >> GDS_USAGE_REPORT >> MSISDN_SC_MA_DA_NEW >> SIM4G_DEVICE_REPORT >> GDS_CDR >> KEEP_MY_NUMBER >> GDS_CONSUMER >> ISP_LOGIN >> DPI_CCN >> SNS >> Sponsored_Data #>> END_SMS1
