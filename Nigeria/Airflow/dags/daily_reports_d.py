...
Daily_Device_Report >> MSC_CCN_RECON_ID >> GGSN_Traffic >> PARTNER_BALANCES >> NO_MGMT_SUMMARY >> Daily_Number_Mgmt >> RATED_VOICE >> RATED_SMS >> RATED_GPRS >> RATED_ADJ_MA >> RATED_REFILL_MA >> RATED_MSC >> RATED_GGSN >> RATED_VOICE_DA >> RATED_SMS_DA >> RATED_B4U_VOICE >> RATED_B4U_GPRS >> FILE_RECON_SUMMARY >> CARDLOAD >> HYNET_REVENUE_SHARE >> REV_PER_BTS_SUMD >> CGI_Validation
