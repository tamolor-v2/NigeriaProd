...
cvmcampaign_daily_campaigns = BashOperator(
    ...
    bash_command= 'bash /nas/share05/scripts/cvm/campaign_dm/run_cvmcampaign_p.sh `date --date="-1 days" +%Y%m%d` `date --date="-1 days" +%Y%m%d` cvmcampaign_daily_campaigns daily 8999 "" 10',
    dag=dag,
    run_as_user='daasuser')
...
cvmcampaign_daily_campaigns_anomalies = BashOperator(
    ...
    bash_command= 'bash /nas/share05/scripts/cvm/campaign_dm/run_cvmcampaign_p.sh  `date --date="-1 days" +%Y%m%d` `date --date="-1 days" +%Y%m%d` cvmcampaign_daily_campaigns_la daily 8999 "" 10',
    dag=dag,
    run_as_user='daasuser')
