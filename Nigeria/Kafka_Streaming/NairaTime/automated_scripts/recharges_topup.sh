...
${KAFKA_SECURITY} \
-cp ${BASE_LOCATION}/lib/ExtDependencyLibs_2.11.jar:${BASE_LOCATION}/lib/ExtDependencyLibs2_2.11.jar:${BASE_LOCATION}/lib/KamanjaInternalDeps_2.11.jar:${BASE_LOCATION}/lib/dbextract_2.11.jar:${BASE_LOCATION}/lib/dbutils_2.11.jar:${BASE_LOCATION}/lib/kafka-clients.jar:${BASE_LOCATION}/lib/presto-jdbc.jar  com.ligadata.utils.dbextract.DBExtract  -cfg  ${BASE_LOCATION}/conf/conf.json -s recharges_topup -sd $Start_Date -ed $End_Date -p 2 -cn  presto1
